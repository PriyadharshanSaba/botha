/**
 * POST /api/admin/blogs/[slug]/publish
 *
 * Flip a draft to published. Idempotent (publishing an already-published
 * blog refreshes publishedAt).
 */
