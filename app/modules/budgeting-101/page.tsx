  ...
  const chapters = [
      ...
      content: {
        ...
        kn: (
          <>
            <div className="module-intro">
              <p>
                ಬಜೆಟ್ ರಚನೆ ಎಂದರೆ &quot;ಬೇಡ&quot; ಎನ್ನುವುದಲ್ಲ, ನಿಜವಾಗಿಯೂ ಮುಖ್ಯವಾದುದಕ್ಕೆ &quot;ಹೌದು&quot; ಎನ್ನುವುದನ್ನು ಕಲಿಯುವ ಕಲೆ. ಇದು ನಿರ್ಬಂಧವಲ್ಲ, ಇದು ದಿಕ್ಕುಸೂಚಿ; ಆದಾಯವನ್ನು ಪ್ರಗತಿಯನ್ನಾಗಿ ಪರಿವರ್ತಿಸುವ ಕೌಶಲ್ಯ. ಹಣ ಹೇಗೆ ಕೆಲಸ ಮಾಡುತ್ತದೆ ಎಂಬುದನ್ನು ನೀವು ಅರಿತಿದ್ದೀರಿ. ಈಗ, ಅದನ್ನು ನಿಮಗಾಗಿ ದುಡಿಸಿಕೊಳ್ಳುವ ಸಮಯ ಬಂದಿದೆ.
              </p>
            </div>
            <hr className="chapter-rule" />
            <p>
              ನಮ್ಮಲ್ಲಿ ಹೆಚ್ಚಿನವರಿಗೆ ತಮ್ಮ ಹಣ ಎಲ್ಲಿ ಹೋಗುತ್ತದೆ ಎಂದು ಗೊತ್ತಿದೆ ಎನಿಸುತ್ತದೆ, ಅದರ ಲೆಕ್ಕದ ಜಾಡು ಹಿಡಿದಾಗಲೇ ನಿಜ ಗೊತ್ತಾಗುತ್ತದೆ. ಒಂದು ಕಡೆ ಕಾಫಿ, ಮತ್ತೊಂದು ಕಡೆ ಮನೆಗೆ ಆಹಾರ ವಿತರಣೆ, ವಾರಾಂತ್ಯದ ಹೊರಗಡೆ ಪ್ರವಾಸ ತಿರುಗಾಟ&hellip; ಮತ್ತು ತಿಂಗಳು ಮುಗಿಯುವ ಮೊದಲೇ ಹಣ ಖಾಲಿಯಾಗಿರುತ್ತದೆ.
            </p>
            <p>
              ಬಜೆಟ್ ರಚನೆ ನಿಮ್ಮ ಹಣಕ್ಕೆ ಸ್ಪಷ್ಟತೆ ನೀಡುತ್ತದೆ. ಅದು ನಿಮ್ಮ ಖರ್ಚನ್ನು ಅಸ್ತವ್ಯಸ್ತದಿಂದ ಉದ್ದೇಶದೆಡೆಗೆ ಪರಿವರ್ತಿಸುತ್ತದೆ. ನಿಮ್ಮ ಗುರಿಗಳನ್ನು ನಿಮ್ಮ ದೈನಂದಿನ ಆಯ್ಕೆಗಳೊಂದಿಗೆ ಜೋಡಿಸುವ ನಕ್ಷೆ ಅದು.
            </p>
            <p>
              ನೀವು ಬಜೆಟ್ ಮಾಡಿದಾಗ, ನೀವು ನಿಮ್ಮನ್ನು ಸೀಮಿತಗೊಳಿಸಿಕೊಳ್ಳುತ್ತಿಲ್ಲ, ನಿಮ್ಮ ಸಾಮರ್ಥ್ಯ ಮತ್ತು ಪ್ರಯತ್ನಗಳಿಗೆ ನಿಜವಾಗಿ ಯೋಗ್ಯವಾದುದನ್ನು ನೀವು ಆರಿಸಿಕೊಳ್ಳುತ್ತಿದ್ದೀರಿ.
            </p>
            <div className="pull-quote">&quot;ನೀವು ಲೆಕ್ಕ ಇಡದೇ ಇರುವುದನ್ನು ನೀವು ಬೆಳೆಸಲು ಸಾಧ್ಯವಿಲ್ಲ&quot;.</div>
            <p>
              ಬಜೆಟ್ ರಚನೆ ಸಂಪತ್ತಿನ ಅಡಿಪಾಯ, ಏಕೆಂದರೆ ಅದು ಜಾಗೃತಿಯನ್ನು ಮೂಡಿಸುತ್ತದೆ, ಮತ್ತು ಜಾಗೃತಿ ನಿಯಂತ್ರಣವನ್ನು ರೂಪಿಸುತ್ತದೆ.
            </p>
            {/* eslint-disable-next-line @next/next/no-img-element */}
      ...
      content: {
        ...
        kn: (
          <>
            ...
            <hr className="chapter-rule" />
            <h3>ಹಂತ ೧: ನಿಮ್ಮ ಪ್ರತಿಯೊಂದು ಆದಾಯದ ಮೂಲವನ್ನು ಪಟ್ಟಿ ಮಾಡಿ</h3>
            <p>ನಿಮ್ಮ ವೇತನ, ಅರೆಕಾಲಿಕ ಕೆಲಸ, ಸ್ವತಂತ್ರ ಉದ್ಯೋಗ, ಅಥವಾ ಬಾಡಿಗೆ ಆದಾಯದ ಗಳಿಕೆ.</p>
            <hr className="chapter-rule" />
            <h3>ಹಂತ ೨: ನಿಮ್ಮ ಖರ್ಚನ್ನು ದಾಖಲಿಸಿ</h3>
            ...
            <p>ನೀವು ಯಾವುದಾದರೂ ಬಜೆಟ್ ಸಾಧನ ಅಥವಾ ಸರಳವಾಗಿ Excel / Google Sheets ಬಳಸಬಹುದು (ನಮ್ಮ ಆದ್ಯತೆ ಇದೇ) — ನಿಮಗೆ ನಿರಂತರತೆ ಮತ್ತು ಪ್ರಾಮಾಣಿಕತೆ ಕಾಪಾಡಲು ಸಹಾಯ ಮಾಡುವುದು ಯಾವುದಾದರೂ ಸರಿ.</p>
            <p>
...

    {
      ...
      content: {
        ...
        kn: (
          <>
            <p>ಈ ಸರಳ ನಿಯಮವು ಕಾಲಾತೀತವಾಗಿ ಜನಪ್ರಿಯವಾಗಿದೆ — ಏಕೆಂದರೆ ಇದು ಸುಲಭ, ಸಮತೋಲಿತ ಮತ್ತು ಪರಿಣಾಮಕಾರಿ.</p>
            <hr className="chapter-rule" />
            <h3>೫೦% &mdash; ಅಗತ್ಯತೆಗಳು</h3>
            <p>ಬಾಡಿಗೆ, ದಿನಸಿ, ನೀರು-ವಿದ್ಯುತ್, ಸಾರಿಗೆಯಂತಹ ಮೂಲಭೂತ ಅವಶ್ಯಕತೆಗಳು.</p>
            <hr className="chapter-rule" />
            <h3>೩೦% &mdash; ಬಯಕೆಗಳು</h3>
            <p>ಹೊರಗಡೆ ಊಟೋಪಚಾರ, ಶಾಪಿಂಗ್, ಹವ್ಯಾಸಗಳು, ಪ್ರಯಾಣ.</p>
            <hr className="chapter-rule" />
            <h3>೨೦% &mdash; ಉಳಿತಾಯ ಮತ್ತು ಹೂಡಿಕೆ</h3>
            <p>ತುರ್ತು ನಿಧಿ, SIP ಗಳು, ಅಥವಾ ದೀರ್ಘಕಾಲಿಕ ಗುರಿಗಳು.</p>
            <hr className="chapter-rule" />
            <p>
              ಇಲ್ಲಿಂದ ಪ್ರಾರಂಭಿಸಿ, ನಂತರ ನಿಮ್ಮ ಬೆಳವಣಿಗೆಗೆ ತಕ್ಕಂತೆ ಅದನ್ನು ಅಳವಡಿಸಿಕೊಳ್ಳಿ. ದೊಡ್ಡ ಗುರಿಗಾಗಿ ಉಳಿತಾಯ ಮಾಡುತ್ತಿದ್ದರೆ, ೪೦-೩೦-೩೦ ರ ಅನುಪಾತ ಅನುಸರಿಸಿ. ನೀವು ವೃತ್ತಿಜೀವನದ ಆರಂಭದಲ್ಲಿದ್ದು ಸಂದರ್ಭಕ್ಕೆ ತಕ್ಕಂತೆ ಬದಲಾವನೆಗಳ ಅಗತ್ಯವಿದ್ದಲ್ಲಿ , ೬೦-೨೫-೧೫ ರ ಅನುಪಾತ ಸರಿಹೊಂದಬಹುದು.
            </p>
...

    {
      ...
      content: {
        ...
        kn: (
          <>
            <p>ಹಣ ನಿರ್ವಹಣೆ ಎಂದರೆ ಕೇವಲ ಖರ್ಚು ಕಡಿತಗೊಳಿಸುವುದಲ್ಲ — ನಿಮ್ಮ ಖರ್ಚನ್ನು ಹೆಚ್ಚು ಜಾಣತನದಿಂದ ಮಾಡುವುದು.</p>
            <p>ವಾಸ್ತವವಾಗಿ ಕೆಲಸಕ್ಕೆ ಬರುವಂತಹ ಕೆಲವು ಅಭ್ಯಾಸಗಳು ಇಲ್ಲಿವೆ:</p>
            <hr className="chapter-rule" />
            <h3>ಉಳಿತಾಯವನ್ನು ಸ್ವಯಂಚಾಲಿತಗೊಳಿಸಿ</h3>
            <p>ವೇತನ ಬಂದ ದಿನವೇ ಹೂಡಿಕೆಗಳಿಗೆ ಸ್ವಯಂ ಚಾಲಿತವಾಗಿ ವರ್ಗಾವಣೆಯಾಗುವಂತೆ ವ್ಯವಸ್ಥೆಗೊಳಿಸಿ.</p>
            <hr className="chapter-rule" />
            <h3>ಪ್ರಚೋದಿತ ಖರೀದಿಗೆ ತಡೆ ಹಾಕಿ</h3>
            <p>ಅನಗತ್ಯ ವಸ್ತುವಿಗೆ ಖರ್ಚು ಮಾಡುವ ಮೊದಲು ೨೪ ಗಂಟೆ ಕಾಯಿರಿ.</p>
            <hr className="chapter-rule" />
            <h3>ಚಂದಾದಾರಿಕೆಗಳನ್ನು ಪರಿಶೀಲಿಸಿ</h3>
            <p>ನಿಯಮಿತವಾಗಿ ಬಳಸದವುಗಳನ್ನು ರದ್ದುಗೊಳಿಸಿ.</p>
            <hr className="chapter-rule" />
            <h3>ಲಕೋಟೆ ವಿಧಾನ ಬಳಸಿ (ಡಿಜಿಟಲ್ ರೂಪದಲ್ಲಿ)</h3>
            <p>&quot;ಮನರಂಜನೆಯ ಹಣ&quot;ವನ್ನು ಅಗತ್ಯ ಖರ್ಚಿನಿಂದ ಪ್ರತ್ಯೇಕವಾಗಿ ಇರಿಸಿ.</p>
            <hr className="chapter-rule" />
            <h3>ಪಾಪಪ್ರಜ್ಞೆಯಿಲ್ಲದ ನಿಧಿ ಇರಲಿ</h3>
            <p>ಇದು ನಿಮ್ಮನ್ನು ನಿಯಮಿತವಾಗಿಯೂ ನಿಶ್ಚಿಂತೆಯಿಂದಲೂ ಇರಿಸುತ್ತದೆ.</p>
...

    {
      ...
      content: {
        ...
        kn: (
          <>
            <p>ಲಾಭದ ಹಿಂದೆ ಓಡುವ ಮೊದಲು, ನೀವು ಸುರಕ್ಷಿತವಾಗಿದ್ದೀರಾ ಎಂದು ಖಚಿತಪಡಿಸಿಕೊಳ್ಳಿ. ತುರ್ತು ನಿಧಿಯಿಲ್ಲದೆ ಹೂಡಿಕೆ ಮಾಡುವುದು, ಬ್ರೇಕ್ ಇಲ್ಲದ ವಾಹನದಲ್ಲಿ ವೇಗವಾಗಿ ಚಲಿಸಿದಂತೆ.</p>
            <p>
              ಉದ್ಯೋಗ ನಷ್ಟ, ವೈದ್ಯಕೀಯ ಖರ್ಚು, ಮನೆ ಅಥವಾ ವಾಹನದ ದುರಸ್ತಿ — ಜೀವನದ ಅನಿರೀಕ್ಷಿತ ಸಂದರ್ಭಗಳು ಯಾವಾಗ ಬೇಕಾದರೂ ಬರಬಹುದು. ತುರ್ತು ನಿಧಿ, ನಿಮ್ಮ ಹೂಡಿಕೆಗೆ ಕೈ ಹಾಕದೆ ಅಥವಾ ಸಾಲದ ಮೊರೆ ಹೋಗದೆ, ಅವುಗಳನ್ನು ಶಾಂತಚಿತ್ತದಿಂದ ನಿಭಾಯಿಸಲು ಸರಾಗ ಆರ್ಥಿಕ ಉಸಿರಾಟದ ಅವಕಾಶ ನೀಡುತ್ತದೆ.
            </p>
            <hr className="chapter-rule" />
            <h3>ಎಷ್ಟು ಉಳಿಸಬೇಕು?</h3>
            <p>ನಿಮ್ಮ ಮಾಸಿಕ ಖರ್ಚಿನ ೩ ರಿಂದ ೬ ತಿಂಗಳಿನಷ್ಟು ಮೊತ್ತವನ್ನು ಪ್ರತ್ಯೇಕವಾಗಿ ಇರಿಸುವ ಗುರಿ ಇಟ್ಟುಕೊಳ್ಳಿ. ನೀವು ಸ್ವಯಂ ಉದ್ಯೋಗಿಯಾಗಿದ್ದರೆ, ಸ್ವತಂತ್ರ ವೃತ್ತಿಪರರಾಗಿದ್ದರೆ, ಅಥವಾ ಅವಲಂಬಿತರನ್ನು ಸಾಕುತ್ತಿದ್ದರೆ, ೬ ರಿಂದ ೯ ತಿಂಗಳ ಖರ್ಚಿಗೆ ಸಾಕಾಗುವಷ್ಟು ದೊಡ್ಡ ನಿಧಿ ನಿರ್ಮಿಸಿ.</p>
            <p>ಇದು ದೊಡ್ಡ ಗುರಿಯಂತೆ ಕಾಣಬಹುದು — ಆದರೆ ನೆನಪಿರಲಿ, ಇದು ನಿಮ್ಮ ಆರ್ಥಿಕ ಸುರಕ್ಷತಾ ಜಾಲ. ಹೂಡಿಕೆಯ ಮೇಲೆ ಗಮನ ಕೇಂದ್ರೀಕರಿಸುವ ಮೊದಲು ಇದನ್ನು ಚುರುಕಾಗಿ ನಿರ್ಮಿಸಿ. ಇಲ್ಲಿ ಹಾಕಿದ ಪ್ರತಿಯೊಂದು ರೂಪಾಯಿಯೂ ನಿಮಗೆ ಮನಃಶಾಂತಿ ತರುತ್ತದೆ.</p>
            <hr className="chapter-rule" />
            <h3>ಎಲ್ಲಿ ಇರಿಸಬೇಕು?</h3>
            <p>ನಿಮ್ಮ ತುರ್ತು ನಿಧಿ ಸುರಕ್ಷಿತ, ಸ್ಥಿರ ಮತ್ತು ತ್ವರಿತವಾಗಿ ಲಭ್ಯವಾಗುವಂತಿರಬೇಕು — ಆದರೆ ಸಾಮಾನ್ಯ ಉಳಿತಾಯ ಖಾತೆಗಿಂತ ಉತ್ತಮ ಆದಾಯ ನೀಡುವಂತಿರಬೇಕು.</p>
            <p>ನೀವು ಇಲ್ಲಿ ಇರಿಸಬಹುದು:</p>
            <p><strong>ಡೆಟ್ ಫಂಡ್‌ಗಳು (ಲಿಕ್ವಿಡ್ ಅಥವಾ ಅಲ್ಟ್ರಾ ಶಾರ್ಟ್-ಟರ್ಮ್ ಫಂಡ್‌ಗಳು):</strong> ೧-೨ ದಿನಗಳಲ್ಲಿ ಸುಲಭ ಹಿಂಪಡೆಯುವಿಕೆಯೊಂದಿಗೆ ಸ್ವಲ್ಪ ಉತ್ತಮ ಆದಾಯ (ಸುಮಾರು ೬-೭%) ನೀಡುತ್ತವೆ.</p>
            <p><strong>ಹೆಚ್ಚಿನ ಬಡ್ಡಿ ದರದ ಉಳಿತಾಯ ಖಾತೆಗಳು:</strong> ಭಾಗಶಃ ಹಿಂಪಡೆಯಲು ಸೂಕ್ತ — ತಕ್ಷಣದ ಲಭ್ಯತೆಗಾಗಿ ೧-೨ ತಿಂಗಳ ಮೊತ್ತ ಇಲ್ಲಿ ಇರಿಸಿ.</p>
            <p><strong>ಅಲ್ಪಾವಧಿ ನಿಶ್ಚಿತ ಠೇವಣಿಗಳು (೧-೩ ತಿಂಗಳು):</strong> ಸ್ಥಿರ ಆದಾಯ ಬಯಸುವವರಿಗೆ ಐಚ್ಛಿಕ, ಆದರೆ ಡೆಟ್ ಫಂಡ್‌ಗಳಿಗಿಂತ ಕಡಿಮೆ ಹೊಂದಿಕೊಳ್ಳುವ ಗುಣ ಹೊಂದಿವೆ ವರ್ಗಾಯಿಸುವ ವ್ಯವಸ್ಥೆ ಮಾಡಿ.</p>
            <p>ಈ ಹಣವನ್ನು ಷೇರುಗಳು, ಮ್ಯೂಚುವಲ್ ಫಂಡ್‌ಗಳು ಅಥವಾ ಯಾವುದೇ ಅಧಿಕ ಅಪಾಯದ ಹೂಡಿಕೆಯಲ್ಲಿ ಹಾಕಬೇಡಿ. ಇಲ್ಲಿ ನಿಮ್ಮ ಗುರಿ ಬೆಳವಣಿಗೆಯಲ್ಲ — ಸ್ಥಿರತೆ ಮತ್ತು ಲಭ್ಯತೆ.</p>
            <hr className="chapter-rule" />
            <h3>ಹೇಗೆ ನಿರ್ಮಿಸಬೇಕು?</h3>
            <p>ಚಿಕ್ಕದಾಗಿ ಪ್ರಾರಂಭಿಸಿ, ಆದರೆ ನಿರಂತರವಾಗಿ ಮುಂದುವರಿಯಿರಿ — ಪ್ರತಿ ತಿಂಗಳು ಸ್ವಯಂಚಾಲಿತ ವರ್ಗಾವಣೆ ಹೊಂದಿಸಿ.</p>
            <p>ಬೋನಸ್, ತೆರಿಗೆ ಹಿಂಪಾವತಿ, ಅಥವಾ ಹೆಚ್ಚುವರಿ ಆದಾಯವನ್ನು ನಿಮ್ಮ ನಿಧಿಗೆ ತಿರುಗಿಸಿ.</p>
            <p>ತುರ್ತು ನಿಧಿಯನ್ನು ನಿಮ್ಮ ಸಾಮಾನ್ಯ ಉಳಿತಾಯದಿಂದ ಪ್ರತ್ಯೇಕವಾಗಿ ಇರಿಸಿ — ಆಕಸ್ಮಿಕವಾಗಿ ಅದನ್ನು ಬಳಸಲಾರದಂತೆ.</p>
            <div className="pull-quote">ತುರ್ತು ನಿಧಿ ಇದ್ದಾಗ, ನೀವು ಅನಿಶ್ಚಿತತೆಯಿಂದ ಇರಲಾರಿರಿ, — ನೀವು ನಿಯಂತ್ರಣದಲ್ಲಿ ಇರುತ್ತೀರಿ. ಇದು ನಿಮ್ಮ ಆರ್ಥಿಕ ಪ್ರಯಾಣದಲ್ಲಿ ಎಲ್ಲದಕ್ಕೂ ಮೂಲ ಆಧಾರ.</div>
            <div className="chapter-note">
...

    {
      ...
      content: {
        ...
        kn: (
          <>
            <p>ಅತ್ಯುತ್ತಮ ಬಜೆಟ್ ಎಂದರೆ ಸ್ವಯಂಚಾಲಿತ ವಾಗುವಂತಹುದು.</p>
            <p>ಹೀಗೆ ಮಾಡಿ:</p>
            <hr className="chapter-rule" />
            <h3>ಉಳಿತಾಯ ಸ್ವಯಂಚಾಲಿತಗೊಳಿಸಿ</h3>
            <p>ಪ್ರತಿ ತಿಂಗಳು ನಿಮ್ಮ ಆದಾಯದ ನಿಗದಿತ ಶೇಕಡಾವಾರು ಮೊತ್ತವನ್ನು ಉಳಿತಾಯ/ಹೂಡಿಕೆಗೆ ಸ್ವಯಂಚಾಲಿತವಾಗಿ ವರ್ಗಾಯಿಸುವ ವ್ಯವಸ್ಥೆ ಮಾಡಿ.</p>
            <hr className="chapter-rule" />
            <h3>ಜ್ಞಾಪನೆಗಳನ್ನು ಅಳವಡಿಸಿಕೊಳ್ಳಿ</h3>
            <p>ಬಿಲ್ ಪಾವತಿ ಮತ್ತು ಆರ್ಥಿಕ ಪರಿಶೀಲನೆಗಾಗಿ ಜ್ಞಾಪನೆಗಳನ್ನು ಅಳವಡಿಸಿಕೊಳ್ಳಿ.</p>
            <hr className="chapter-rule" />
            <h3>ಬಜೆಟ್ ಅಪ್ಲಿಕೇಶನ್ ಅಥವಾ Excel ಬಳಸಿ</h3>
            <p>ನಿಮ್ಮ ಪ್ರಗತಿ ಗಮನಿಸಲು ಬಜೆಟ್ ಅಪ್ಲಿಕೇಶನ್ ಅಥವಾ Excel ಬಳಸಿ.</p>
            <hr className="chapter-rule" />
            <h3>ತಿಂಗಳಿಗೊಮ್ಮೆ ಪರಿಶೀಲಿಸಿ, ಪ್ರತಿದಿನ ಅಲ್ಲ</h3>
            <p>ನಿಮ್ಮ ಆರ್ಥಿಕ ಸ್ಥಿತಿಯನ್ನು ಪ್ರತಿದಿನ ಅಲ್ಲ — ತಿಂಗಳಿಗೊಮ್ಮೆ ಪರಿಶೀಲಿಸಿ.</p>
...

    {
      ...
      content: {
        ...
        kn: (
          <>
            <p>ಬಜೆಟ್ ರಚನೆ ಎಂದರೆ ಕಡಿತಗೊಳಿಸುವುದಲ್ಲ — ಉತ್ತಮವಾದುದನ್ನು  ಆಯ್ಕೆ ಮಾಡುವುದು. ಇದು ನಿರ್ಬಂಧವಲ್ಲ; ಇದು ಸ್ವಾತಂತ್ರ್ಯ — ಪ್ರಾಮುಖ್ಯವಾದುದಕ್ಕೆ ಖರ್ಚು ಮಾಡುವ, ಮಹತ್ವದ್ದನ್ನು ಉಳಿಸುವ, ಮತ್ತು ನಿಮ್ಮ ಷರತ್ತುಗಳ ಮೇಲೆ ಜೀವನ ನಡೆಸುವ ಸ್ವಾತಂತ್ರ್ಯ.</p>
            <p>
              ನಿಮ್ಮ ಬಜೆಟ್‌ನಲ್ಲಿನ ಪ್ರತಿಯೊಂದು ನಿರ್ಧಾರವೂ ನಿಮ್ಮ ಆದ್ಯತೆಗಳ ಪ್ರತಿಬಿಂಬ ಮತ್ತು ನಿಮ್ಮ ಭವಿಷ್ಯಕ್ಕೆ ನಿಮಗೆ ನೀವೇ ನೀಡುವ ಮೌನ ವಾಗ್ದಾನ. ನೀವು ಹಣದ ಬಗ್ಗೆ ಯೋಜನೆ ರೂಪಿಸಿದಾಗ ಅದರ ಮೇಲೆ, ನಿಯಂತ್ರಣ ದೊರೆಯುತ್ತದೆ. ಮತ್ತು ನಿಯಂತ್ರಣದೊಂದಿಗೆ ಆತ್ಮವಿಶ್ವಾಸ, ಮನಃಶಾಂತಿ ಮತ್ತು ಬೆಳವಣಿಗೆ ಬರುತ್ತದೆ.
            </p>
            <hr className="chapter-rule" />
            <p>
              ನೀವು ಇಲ್ಲಿಯವರೆಗೆ ಬಂದಿದ್ದೀರಿ! ಹಣದ ಚಲನೆ ಹೇಗೆ, ಎಲ್ಲಿ ಹೋಗುತ್ತದೆ, ಮತ್ತು ಅದನ್ನು ನಿಮಗಾಗಿ ಹೇಗೆ ಕೆಲಸ ಮಾಡಿಸಿಕೊಳ್ಳಬೇಕು ಎಂಬುದನ್ನು ಅರ್ಥಮಾಡಿಕೊಂಡಿದ್ದೀರಿ. ಇದು ಚಿಕ್ಕ ಸಾಧನೆಯೇನಲ್ಲ. ನೀವು ಅಡಿಪಾಯ ನಿರ್ಮಿಸಿದ್ದೀರಿ — ಜಾಗೃತಿ, ಸ್ಪಷ್ಟತೆ ಮತ್ತು ಉದ್ದೇಶ.
            </p>
