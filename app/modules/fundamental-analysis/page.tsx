        ...
        <div className="complete-body">
          <div className="complete-inner">
            ...
            <p className="complete-sub">
              You&apos;ve finished Fundamental Analysis &mdash; all {chapters.length} chapters.
              You now have a complete framework: from reading financial statements and
              understanding ratios, to evaluating moats, management quality, intrinsic value,
              and combining fundamentals with technicals.
            </p>
