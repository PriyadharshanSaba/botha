...
export default function FundamentalAnalysisPage() {
  ...
  const chapters = [
    {
      ...
      <div className="ch-illustration" style={{padding:"0",overflow:"hidden",borderRadius:"16px"}}><img src="/fundamental-analysis/image1.png" alt="A shopkeeper at a small grocery store - illustrating how a business makes money" style={{width:"100%",height:"auto",display:"block"}} /></div>
      ...
      <div className="ch-illustration" style={{padding:"0",overflow:"hidden",borderRadius:"16px"}}><img src="/fundamental-analysis/image2.png" alt="The same shop 5 years later - now a supermarket, illustrating long-term business growth" style={{width:"100%",height:"auto",display:"block"}} /></div>
      <hr className="chapter-rule" />
      ...
      <p>This is why fundamental analysis attempts to understand not only how the company is performing today - but also how it may perform in the future.</p>
      <hr className="chapter-rule" />
    ...
    },
    {
      ...
      <p>Businesses require capital to operate - from shareholders, retained profits or borrowed funds - to build factories, invest in technology, hire employees and expand. The way a company uses its capital is one of the most important factors in long-term investment success.</p>
    ...
    },
    {
      ...
      content: (
        <>
          <p>Throughout this module, we will discuss many elements of fundamental analysis - financial statements, growth trends, return ratios, valuation and management quality. To apply these concepts in practice, investors need reliable sources where they can obtain company data.</p>
      <blockquote className="pull-quote">Do not stress or focus on the numbers in the snippets shown throughout this module - the concepts will be covered in detail in the chapters that follow.</blockquote>
      <hr className="chapter-rule" />
    ...
    },
    {
      ...
      content: (
        <>
          <p>Once we understand how a business makes money, the next step is to evaluate how profitable it actually is. The financial statement that tells this story is the Income Statement - it summarizes a company's financial performance over a specific period, usually a quarter or a year.</p>
  ...
  <div style={{width:"100%",maxWidth:"480px"}}>
    ...
    <div style={{background:"linear-gradient(135deg,#3a1a4a,#5c2a6e)",color:"#fdfcf9",borderRadius:"0 0 14px 14px",padding:"14px 20px",textAlign:"center"}}>
      ...
      <div style={{fontSize:"0.78em",opacity:"0.75",marginTop:"3px"}}>Belongs to shareholders - the final reward</div>
    </div>
  ...
  <p style={{textAlign:"center",fontSize:"0.8em",color:"#888",marginTop:"0.8rem",fontStyle:"italic"}}>Each stage provides insight into a different aspect of the business.</p>
      ...
      <hr className="chapter-rule" />
      <h3>Net Profit - The Bottom Line</h3>
      ...
      <hr className="chapter-rule" />
      <h3>Profit Margins - Measuring Efficiency</h3>
    ...
    {
      title: "Chapter 5: The Balance Sheet - Understanding Financial Strength",
      content: (
        <>
      ...
      <p><strong>Current Assets</strong> - assets expected to be converted into cash within one year: cash and equivalents, accounts receivable, inventory and short-term investments. These help the company manage day-to-day operations and liquidity.</p>
      <p><strong>Non-Current Assets</strong> - long-term resources: factories, machinery, office buildings, technology infrastructure and intangible assets such as patents or brand value. Companies like Asian Paints invest heavily in manufacturing plants and distribution infrastructure that appear as long-term assets.</p>
      <hr className="chapter-rule" />
      <h3>Liabilities - What the Company Owes</h3>
      <p><strong>Current Liabilities</strong> - obligations payable within one year: short-term borrowings, accounts payable, taxes payable and short-term provisions.</p>
      <p><strong>Non-Current Liabilities</strong> - long-term obligations beyond one year: long-term loans, corporate bonds and long-term lease obligations. Excessive debt can increase financial risk during economic downturns.</p>
      <hr className="chapter-rule" />
      <h3>Shareholders' Equity - The Owners' Claim</h3>
      ...
      <p>Debt can accelerate growth if used responsibly - to expand production capacity, invest in new technology or enter new markets. However, excessive debt increases financial risk. Investors analyze the Debt-to-Equity Ratio and Interest Coverage Ratio to determine whether debt levels are manageable.</p>
    ...
    },
    {
      ...
      <p><strong>1. Profitability Ratios</strong> - Gross Margin, Operating Margin, Net Profit Margin. Reveal whether the company has strong pricing power, efficient operations and competitive advantages.</p>
      <p><strong>2. Efficiency Ratios</strong> - Return on Equity (ROE), Return on Capital Employed (ROCE), Asset Turnover. Measure how effectively the company uses its assets and capital to generate revenue and profit.</p>
      <p><strong>3. Financial Strength Ratios</strong> - Debt-to-Equity Ratio, Interest Coverage Ratio, Current Ratio. Help investors evaluate the company's ability to meet its financial obligations.</p>
      <p><strong>4. Valuation Ratios</strong> - Price-to-Earnings (P/E), Price-to-Book (P/B), EV/EBITDA. Help investors determine whether a stock appears expensive, fairly valued or undervalued relative to its fundamentals.</p>
      <hr className="chapter-rule" />
    ...
    {
      title: "Chapter 8: Profitability Ratios - Interpreting Margins",
      content: (
        <>
      ...
      <hr className="chapter-rule" />
      <h3>Gross Margin - Product Economics</h3>
      ...
      <hr className="chapter-rule" />
      <h3>Operating Margin - Operational Efficiency</h3>
      ...
      <hr className="chapter-rule" />
      <h3>Net Profit Margin - Final Profitability</h3>
    ...
    {
      title: "Chapter 9: Return Ratios - Measuring Capital Efficiency",
      content: (
        <>
      ...
      <hr className="chapter-rule" />
      <h3>Asset Turnover Ratio - Efficiency of Asset Usage</h3>
    ...
    },
    {
      ...
      <hr className="chapter-rule" />
      <h3>Debt-to-Equity Ratio - Measuring Financial Leverage</h3>
      <p>Formula: Debt-to-Equity Ratio = Total Debt ÷ Shareholders' Equity</p>
      <p>Example: Total Debt = ₹500 crore. Shareholders' Equity = ₹1,000 crore. D/E Ratio = 0.5. The company uses ₹0.50 of debt for every ₹1 of shareholder capital. Lower ratios generally indicate a more conservative balance sheet. However, acceptable levels of debt vary across industries - capital-intensive sectors such as infrastructure may naturally carry higher debt, while asset-light businesses often operate with minimal borrowing. This ratio must be compared with peers.</p>
      <hr className="chapter-rule" />
      <h3>Interest Coverage Ratio - Ability to Service Debt</h3>
      ...
      <hr className="chapter-rule" />
      <h3>Current Ratio - Short-Term Liquidity</h3>
    ...
    },
    {
      ...
      <hr className="chapter-rule" />
      <h3>EV/EBITDA - Enterprise Value Comparison</h3>
      ...
      <p>Ratios should never be interpreted in isolation. Fast-growing companies may trade at higher valuations because investors expect profits to increase significantly. A low P/E does not automatically mean a stock is cheap - it may reflect weak growth prospects, declining industries or financial risk. High valuations are sometimes justified when companies possess strong competitive advantages, high return on capital and long growth runways.</p>
    ...
    },
    {
      ...
      <p>Suppose a company earns ₹100 crore in profit today. At 15% annual growth, profit will reach approximately ₹201 crore in 5 years and ₹405 crore in 10 years - profits quadruple in about a decade. If the market continues to value the business at a similar multiple, the stock price will tend to reflect this expansion.</p>
      <hr className="chapter-rule" />
      <h3>Revenue Growth - Expanding the Business</h3>
      ...
      <hr className="chapter-rule" />
      <h3>Profit Growth - Turning Sales into Earnings</h3>
      <p>Profits may grow faster than revenue due to operating leverage - when a company's fixed costs remain relatively stable while revenue increases, additional revenue contributes more directly to profits. Example: Revenue growth = 10% annually, Profit growth = 18% annually - the company is becoming more efficient as it grows. Infosys has historically benefited from operating leverage. HUL often improves profitability through better supply chains, scale advantages and premium product launches.</p>
      <hr className="chapter-rule" />
    ...
    },
    {
      ...
      <p>Margin expansion occurs when profit margins increase over time as the business scales - because fixed costs are spread across larger revenue, supply chains become more efficient or stronger brands allow premium pricing. HUL has historically improved margins through strong brand portfolios and operational efficiencies.</p>
    ...
    },
    {
      ...
      <p>Some sectors require substantial investment in physical infrastructure - power generation, aviation, telecommunications and infrastructure. Companies like NTPC require large investments in power plants and energy infrastructure. In contrast, asset-light industries such as consulting, software services or digital platforms require far less physical infrastructure and may scale more easily while maintaining strong returns on capital.</p>
      <hr className="chapter-rule" />
      <h3>Cyclical vs Structural Industries</h3>
      <p>Cyclical industries are closely tied to economic cycles - metals, real estate and automobiles. Companies such as Maruti Suzuki may experience fluctuations depending on economic conditions, consumer spending and interest rates. Structural growth industries benefit from long-term demand trends that persist across economic cycles - technological adoption, healthcare needs and digital infrastructure. Understanding whether a company is in a cyclical or structural industry helps investors set realistic expectations about growth stability.</p>
      <hr className="chapter-rule" />
    ...
    },
    {
      ...
      <p>High-quality management teams usually focus on long-term business development rather than short-term results - investing in R&amp;D, strengthening distribution networks, building new capabilities and expanding into emerging markets. Pidilite Industries has steadily expanded its product portfolio and distribution reach over many years.</p>
    ...
    },
    {
      ...
      <p>Most annual reports begin with a description of the company's business model and operations - its core products or services, key revenue segments, geographic presence and major customer groups. Companies operating across multiple segments may provide a breakdown of revenue contributions from different divisions.</p>
    ...
    },
    {
      ...
      <p>Intrinsic value estimates are available on platforms such as Trendlyne and Tijori Finance. However, intrinsic value is always an estimate, not an exact number - investors often treat it as a range rather than a precise figure.</p>
      <hr className="chapter-rule" />
      ...
      <hr className="chapter-rule" />
      <h3>Margin of Safety - Protecting Against Uncertainty</h3>
    ...
    },
    {
      ...
      <p>A red flag arises when debt levels increase significantly without a clear improvement in revenue, profitability or return on capital - signs include rapidly increasing debt, declining interest coverage ratios and heavy reliance on borrowing.</p>
      ...
      <p>Frequent or poorly integrated acquisitions may indicate risks - rapid expansion through acquisitions rather than organic growth, significant goodwill accumulation, or rising debt used to finance acquisitions.</p>
      ...
      <p>Companies with highly complex structures - numerous subsidiaries, extensive related-party transactions, opaque ownership arrangements - can make it difficult for investors to fully understand their financial relationships. While complexity does not automatically imply misconduct, transparency is generally considered a positive attribute.</p>
      <p>Frequent or abrupt changes in strategic direction may signal uncertainty within management - rapid diversification into unrelated industries, inconsistent capital allocation decisions or repeated restructuring initiatives. Stable companies typically pursue clear and consistent long-term strategies.</p>
    ...
    },
    {
      ...
      <p>Technical analysis examines price trends, support and resistance levels, momentum indicators and volume behavior. These tools help investors understand how market participants are positioning themselves around a stock. For example, if a fundamentally strong company experiences a temporary pullback during a broader market correction, technical analysis may help identify whether the stock is approaching a historical support level or a structural pullback zone - improving entry timing rather than buying at extended price levels.</p>
      <hr className="chapter-rule" />
      <h3>A Simple Combined Framework</h3>
      <p><strong>Step 1 - Identify Strong Businesses:</strong> Using fundamental analysis, look for companies with strong earnings growth, high return on capital, manageable debt levels, competitive advantages and capable management. This builds a shortlist of companies worth owning.</p>
      <p><strong>Step 2 - Use Technical Analysis for Entry Timing:</strong> Once a fundamentally strong company is identified, observe overall trend direction, key support levels, pullback zones and volume behavior. If a stock remains in a long-term uptrend but temporarily pulls back toward support, investors may consider this a more favorable entry point.</p>
      <hr className="chapter-rule" />
    ...
    {
      title: "Chapter 21: Case Study - Analyzing a High-Quality Compounder (Pidilite)",
      content: (
        <>
      ...
      <p>Pidilite has historically generated high returns on capital employed (ROCE), reflecting its ability to produce strong profits relative to the capital invested - indicating efficient use of capital, strong competitive advantages and scalable business operations.</p>
    ...
    {
      title: "Chapter 22: Case Study - Understanding a Cyclical Business (Tata Steel)",
      content: (
        <>
          <p>Not all businesses behave like stable compounders. Some industries experience large swings in profitability depending on economic conditions, commodity prices and supply-demand cycles. These businesses are known as cyclical companies. In this chapter, we examine Tata Steel - a well-known example of a cyclical business closely tied to economic activity, construction demand, infrastructure spending and global commodity prices.</p>
      <hr className="chapter-rule" />
      <h3>Understanding the Industry and Revenue Cycles</h3>
      <p>The steel industry is heavily influenced by global demand and supply dynamics. Demand rises during infrastructure expansion, real estate growth, industrial production and economic expansion - causing steel prices and profitability to increase significantly. When economic activity slows or supply increases faster than demand, steel prices may decline. Because steel is largely a commodity product, companies often have limited pricing power. Profitability can therefore change dramatically depending on market conditions.</p>
    ...
    {
      title: "Chapter 23: Case Study - Understanding a Turnaround Story (ICICI Bank)",
      content: (
        <>
          <p>A turnaround occurs when a company that previously faced serious challenges begins to improve its performance through changes in strategy, management, operations or financial discipline. Turnaround situations can sometimes create attractive investment opportunities, but they also carry higher uncertainty compared to stable compounders. In this chapter, we examine ICICI Bank - an example of a turnaround in the Indian banking sector.</p>
      <hr className="chapter-rule" />
      <h3>Understanding the Problem Phase</h3>
      <p>Several years ago, ICICI Bank faced challenges related to asset quality - the health of the loans that banks provide to borrowers. During periods of rapid lending growth, some loans may later become non-performing assets (NPAs) if borrowers fail to repay. At one stage, ICICI Bank experienced rising levels of non-performing loans, credit losses and investor concerns about risk management. These challenges affected the bank's profitability and created uncertainty around future growth.</p>
      <hr className="chapter-rule" />
      ...
      <main className="container module-detail-container">
        ...
        <div className="complete-inner">
          ...
          <div className="complete-title">
            Module 6<br /><em>Complete.</em>
          </div>
          <p className="complete-sub">
            You&apos;ve finished Fundamental Analysis &mdash; all 25 chapters. You now have a complete framework for evaluating businesses through their financials, growth, competitive advantages, management quality, valuation and more.
          </p>
