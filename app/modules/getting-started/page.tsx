  ...
  const chapters = [
    {
      ...
      <p>Two accounts are commonly used when investing in the stock market. A <strong>Trading Account</strong> is used to place buy and sell orders in the market &mdash; it acts as the interface between you and the stock exchange, allowing you to place buy or sell orders, view market prices and execute trades. A <strong>Demat Account</strong> (dematerialized account) is where your securities are stored electronically. When you purchase shares, they are credited to your demat account; when you sell them, they are debited. Think of it as a digital vault for your investments, similar to a bank account that holds money. In practice, most brokerage platforms open both accounts together, so investors rarely need to manage them separately.</p>
      <hr className="chapter-rule" />
      <h3>KYC, PAN &amp; Aadhaar Requirements</h3>
      <p>Before opening an investment account, investors must complete the <strong>Know Your Customer (KYC)</strong> process &mdash; a regulatory requirement that verifies the investor's identity. The KYC process involves identity verification, address verification and linking your bank account. Most platforms now allow this to be completed online through Aadhaar-based verification and video KYC.</p>
      <p>The most important documents required include: PAN (Permanent Account Number &mdash; mandatory for all financial transactions in the securities market), Aadhaar card (used for identity verification and digital KYC), and bank account details (for transferring funds and receiving redemption proceeds).</p>
      <hr className="chapter-rule" />
    ...
    },
    {
      ...
      <blockquote className="pull-quote">Investing is a structured journey, not a race. Each step &mdash; emergency fund, SIPs, core portfolio, direct stocks &mdash; builds on the previous one. Rushing ahead skips the foundation.</blockquote>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          <p>After opening your investment accounts, the next practical question becomes: How should you allocate your first investment? A good beginner portfolio should aim to balance three things &mdash; growth potential, diversification and risk management. The goal is not to pick perfect investments, but to build a simple, diversified structure that allows you to participate in long-term market growth while avoiding unnecessary concentration.</p>
      <hr className="chapter-rule" />
      ...
      <div className="ch-card-row">
        <div className="ch-card"><div className="ch-card-icon">📊</div><div className="ch-card-title">40% &mdash; Nifty 50 Index Fund</div><div className="ch-card-desc">₹40,000 · Core foundation · Broad exposure to India's leading companies · Low cost and diversified</div></div>
        <div className="ch-card"><div className="ch-card-icon">🌐</div><div className="ch-card-title">30% &mdash; Flexi-cap Mutual Fund</div><div className="ch-card-desc">₹30,000 · Active management · Exposure beyond the Nifty 50 · Potential to capture emerging growth</div></div>
        <div className="ch-card"><div className="ch-card-icon">🏢</div><div className="ch-card-title">20% &mdash; Direct Stocks</div><div className="ch-card-desc">₹20,000 · 2&ndash;3 companies · Apply fundamental &amp; technical analysis · Learning opportunity</div></div>
      </div>
      <hr className="chapter-rule" />
    ...
    },
    {
      ...
      <p>A commonly recommended guideline is to invest 20&ndash;30% of monthly income. Consider an investor earning ₹70,000 per month. After accounting for living expenses, the investor allocates approximately ₹23,000 per month &mdash; roughly 30% of income &mdash; toward savings and investments.</p>
      <div className="ch-card-row">
        <div className="ch-card"><div className="ch-card-icon">📈</div><div className="ch-card-title">₹10,000 &mdash; Nifty 50 Index SIP</div><div className="ch-card-desc">Core long-term growth engine. Exposure to India's largest companies with low costs.</div></div>
        <div className="ch-card"><div className="ch-card-icon">🌐</div><div className="ch-card-title">₹5,000 &mdash; Flexi-cap SIP</div><div className="ch-card-desc">Diversification beyond the largest companies. Active management across all market caps.</div></div>
        <div className="ch-card"><div className="ch-card-icon">🥇</div><div className="ch-card-title">₹3,000 &mdash; Gold Allocation</div><div className="ch-card-desc">Portfolio diversification across asset classes. Hedge during market uncertainty.</div></div>
      </div>
      <p style={{marginTop:"16px"}}>The remaining <strong>₹5,000</strong> goes toward a savings buffer &mdash; strengthening the emergency fund, covering short-term financial goals, or handling unexpected expenses. This ensures investments are not disrupted by sudden financial needs.</p>
      <hr className="chapter-rule" />
      ...
      <blockquote className="pull-quote">Successful investing is rarely about finding the perfect stock. More often, it is about building a consistent system that runs month after month &mdash; letting discipline and compounding work quietly in the background.</blockquote>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          <p>After building a foundation through mutual funds and index investing, many investors naturally become interested in studying individual companies. Direct stock investing allows investors to apply the concepts learned earlier in the course &mdash; fundamental analysis, valuation and technical timing. However, beginners often make the mistake of immediately chasing "hot stocks" or following tips. A better approach is to start with a structured filter for identifying strong companies to study. The goal of this chapter is not to recommend specific stocks, but to teach a framework for selecting companies worth researching.</p>
      <hr className="chapter-rule" />
      <h3>The Stock Selection Checklist</h3>
      <p>A strong candidate often demonstrates several of the following characteristics. <strong>Market Leader:</strong> companies that dominate their industry, have strong brands, benefit from large distribution networks and maintain pricing power &mdash; these often demonstrate stability and resilience during economic cycles. <strong>Consistent Revenue Growth:</strong> revenue that has grown steadily across several years, indicating expanding demand, market share gains or an industry that is itself growing. <strong>Strong Return on Equity (ROE):</strong> measures how efficiently a company uses shareholder capital to generate profits &mdash; consistently strong ROE often signals brand power, operational efficiency or pricing power. <strong>Low Debt Levels:</strong> manageable borrowing, strong interest coverage and consistent cash flow generation &mdash; lower debt provides flexibility and resilience. <strong>Large or Expanding Industry:</strong> even a well-managed company may struggle if the industry itself is stagnant &mdash; look for companies operating where long-term demand is likely to expand.</p>
      <hr className="chapter-rule" />
      <h3>Sectors Worth Studying</h3>
      <p>When beginning to analyze companies, starting with sectors that form the backbone of the economy can be helpful. <strong>Banking</strong> &mdash; plays a central role in economic growth, well-regulated and closely tied to economic expansion. <strong>FMCG (Fast-Moving Consumer Goods)</strong> &mdash; everyday consumer products where demand tends to be relatively stable and easier for investors to understand. <strong>Information Technology (IT)</strong> &mdash; India has built a strong global presence here, with many companies benefiting from global demand for digital services. <strong>Manufacturing</strong> &mdash; industrial goods and components; as industrial activity expands, manufacturing businesses may benefit from increasing domestic and global demand. <strong>Energy</strong> &mdash; oil, gas, electricity and renewable power; energy demand is closely linked to economic activity.</p>
      <hr className="chapter-rule" />
      <h3>How to Shortlist Companies</h3>
      <p>A simple process: identify a sector that interests you, list several companies operating in that sector, review basic financial metrics (revenue growth, profitability, debt levels), narrow the list to a few companies with strong fundamentals, then study these businesses more deeply using the fundamental and technical analysis tools covered earlier in the course. When beginning to analyze stocks, the objective is not to immediately build a large portfolio of individual companies &mdash; instead, focus on learning how to evaluate businesses carefully. Studying a small group of high-quality companies across different sectors helps you develop the ability to understand business models, interpret financial statements, recognize industry trends and evaluate long-term growth potential.</p>
      <blockquote className="pull-quote">Start with the filter, not the stock. Use the checklist &mdash; market leadership, consistent growth, strong ROE, low debt, expanding industry &mdash; and let the analysis lead you to the right companies.</blockquote>
        </>
      ),
    },
    {
      ...
      <p>Daily portfolio checking can quickly become a habit, especially when markets are volatile. When investors monitor prices every day, they are more likely to react emotionally to small market fluctuations, feel pressure to buy or sell frequently, and focus on short-term movements rather than long-term performance. Markets move up and down every day &mdash; these fluctuations are normal and rarely reflect meaningful changes in the underlying businesses you own. Checking the portfolio too often can turn investing into something that feels like trading, even if the original intention was long-term investing.</p>
      <hr className="chapter-rule" />
      ...
      <p><strong>Quarterly Review:</strong> Every three months, conduct a slightly deeper review &mdash; examining company earnings results for direct stock holdings, reviewing major developments in key sectors, and checking whether any investment thesis has materially changed. Quarterly reviews help investors stay informed without reacting to daily noise.</p>
      ...
      <p>Research and experience show that investors who check their portfolios constantly are more likely to panic during short-term market declines, sell quality investments prematurely and chase short-term trends or market excitement. In contrast, investors who maintain a structured review schedule tend to remain focused on long-term fundamentals rather than daily volatility. Successful investing is not about reacting to every market movement &mdash; it is about allowing strong businesses and diversified portfolios to compound steadily over time.</p>
    ...
    },
    {
      ...
      <p>For direct stock investments, the first question should always be about the quality of the business itself &mdash; not the recent stock price. Consider whether the company continues to demonstrate steady revenue growth, healthy profitability, a strong competitive position and capable management. If the underlying business remains strong, short-term price fluctuations often become less important.</p>
      <hr className="chapter-rule" />
