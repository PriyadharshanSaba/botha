...
export default function GettingStartedPage() {
  ...
  const chapters = [
    ...
    },
    {
      ...
      <p>Before investing heavily in markets, the first priority should be establishing a financial safety buffer. An emergency fund typically covers 6–12 months of essential living expenses and should be kept in highly liquid and low-risk instruments such as savings accounts or liquid mutual funds. Without an emergency fund, investors may be forced to sell investments during unfavorable market conditions, which can interrupt long-term compounding.</p>
      <hr className="chapter-rule" />
    ...
    },
    {
      ...
      <div className="ch-card-row">
        ...
        <div className="ch-card"><div className="ch-card-icon">🏢</div><div className="ch-card-title">20% — Direct Stocks</div><div className="ch-card-desc">₹20,000 · 2–3 companies · Apply fundamental &amp; technical analysis · Learning opportunity</div></div>
      </div>
      <hr className="chapter-rule" />
    ...
    },
    {
      ...
      <p>A commonly recommended guideline is to invest 20–30% of monthly income. Consider an investor earning ₹70,000 per month. After accounting for living expenses, the investor allocates approximately ₹23,000 per month — roughly 30% of income — toward savings and investments.</p>
      <div className="ch-card-row">
      ...
      <p style="margin-top:16px;">The remaining <strong>₹5,000</strong> goes toward a savings buffer — strengthening the emergency fund, covering short-term financial goals, or handling unexpected expenses. This ensures investments are not disrupted by sudden financial needs.</p>
      <hr className="chapter-rule" />
    ...
    },
    {
      ...
      <hr className="chapter-rule" />
      <h3>Months 1–2: Strengthen Your Financial Base</h3>
      ...
      <hr className="chapter-rule" />
      <h3>Months 3–4: Start Systematic Investing</h3>
      ...
      <p>The first year of investing is not about achieving extraordinary returns. Instead, it is about building the habits and systems that allow long-term compou
        </>
      ),
    },
  ];
