...
export const chapters = [
  ...
  // ==============================
  {
    title: {
      ...
      kn: "ಅಧ್ಯಾಯ ೧: ಹಣದ ಕಥೆ — ವಿನಿಮಯದಿಂದ ಡಿಜಿಟಲ್ ಯುಗದವರೆಗೆ",
    },
    content: {
      en: (
        <>
  ...
  // ==============================
  {
    title: {
      ...
      kn: "ಅಧ್ಯಾಯ ೨: ಮುಂದಿನ ಅಧ್ಯಾಯ ಆಯವ್ಯಯ ಕಲೆ",
    },
    content: {
      en: (
        <>
  ...
  // ==============================
  {
    title: {
      ...
      kn: "ಅಧ್ಯಾಯ ೩: ಉಳಿತಾಯದಿಂದ ಬೆಳವಣಿಗೆವರೆಗೆ - ಹೂಡಿಕೆಯ ಶಕ್ತಿ",
    },
    content: {
      en: (
        <>
      ...
      kn: (
        <>
          ...
          <p>
            ಹೂಡಿಕೆ ಎಂದರೆ ನೀವು ವಿಶ್ರಾಂತಿ ಪಡೆಯುತ್ತಿರುವಾಗಲೂ ನಿಮ್ಮ ಹಣವನ್ನು ದುಡಿಸುವ ವಿಧಾನ. ಇದು ಕಠಿಣ ಅಪಾಯಗಳನ್ನು ತೆಗೆದುಕೊಳ್ಳುವುದು ಅಲ್ಲ ಅಥವಾ ತ್ವರಿತ ಲಾಭಗಳಿಗಾಗಿ ಬೆನ್ನು ಹತ್ತುವುದು - ಅಲ್ಲ ಹೂಡಿಕೆ ಎಂದರೆ ಮಾಲಿಕತ್ವ, ಸಹನೆ, ಮತ್ತು ಶಿಸ್ತು.
          </p>
          <p>
  ...
  // ==============================
  {
    title: {
      ...
      kn: "ಅಧ್ಯಾಯ ೪: ಹೂಡಿಕೆದಾರನಂತೆ ಯೋಚಿಸುವುದು ಹೇಗೆ?",
    },
    content: {
      en: (
        <>
  ...
  // ==============================
  {
    title: {
      ...
      kn: "ಅಧ್ಯಾಯ ೫: ಹೂಡಿಕೆಯ ಆಯ್ಕೆಗಳನ್ನು ಅರ್ಥಮಾಡಿಕೊಳ್ಳುವುದು",
    },
    content: {
      en: (
        <>
  ...
  // ==============================
  {
    title: {
      ...
      kn: "ಅಧ್ಯಾಯ ೬: ಹೂಡಿಕೆಯಲ್ಲಿ ಅಪಾಯ ಮತ್ತು ಭಾವನೆಗಳ ಪಾತ್ರ",
    },
    content: {
      en: (
        <>
  ...
  // ==============================
  {
    title: {
      ...
      kn: "ಅಧ್ಯಾಯ ೭: ಹೂಡಿಕೆ ಪ್ರಾರಂಭಿಸುವುದು ಹೇಗೆ?",
    },
    content: {
      en: (
        <>
      ...
      kn: (
        <>
          ...
          <p>
            ನೀವು ಭಾವನಾತ್ಮಕವಾಗಿಯೂ ಮತ್ತು ಆರ್ಥಿಕವಾಗಿಯೂ ಎಷ್ಟರ ಮಟ್ಟಿಗೆ ಮಾರುಕಟ್ಟೆ ಅಸ್ಥಿರತೆಯನ್ನು ನಿಭಾಯಿಸಬಹುದು ಎಂಬುದರ ಬಗ್ಗೆ ನಿಮ್ಮೊಂದಿಗೆ ನೀವು ಪ್ರಾಮಾಣಿಕವಾಗಿರಿ. ನೀವು ಅಪಾಯವನ್ನು ಎದುರಿಸುವ ಮಟ್ಟವು ನಿಮ್ಮ ಷೇರುಗಳು, ಫಂಡ್‌ಗಳು, ಬಾಂಡ್‌ಗಳು, ಅಥವಾ ಚಿನ್ನ ಹೂಡಿಕೆ ಮಿಶ್ರಣದ ಪ್ರಮಾಣವನ್ನು ಮಾರ್ಗದರ್ಶಿಸುತ್ತದೆ.
          </p>
          <hr className="chapter-rule" />
  ...
  // ==============================
  {
    title: {
      ...
      kn: "ಅಧ್ಯಾಯ ೮: ನೀವು ಮೊದಲ ಹೆಜ್ಜೆ ಇಟ್ಟಿದ್ದೀರಿ ಈಗ ಪ್ರಯಾಣವನ್ನು ಆರಂಭಿಸೋಣ",
    },
    content: {
      en: (
        <>
