...
// ─────────────────────────────────────────────────────────────────────────────
// Chapter content — bilingual title + content (en / kn).
// ─────────────────────────────────────────────────────────────────────────────
    ...
    content: {
      en: (
        <>
          ...
          <p>These funds invest primarily in <strong>stocks</strong>. Because stocks fluctuate, equity funds can go up and down in the short term, but historically, they create the <strong>highest long-term wealth</strong>.</p>
          ...
          <p>Invest in India&apos;s top 100 biggest, most stable companies. <strong>Think:</strong> Reliance, TCS, HDFC Bank.</p>
          <ul className="pl-6 list-none space-y-1"><li>✔ Lower risk than other equity types</li><li>✔ Good for beginners</li><li>✔ Consistent performance</li></ul>
          <p><strong>b) Mid-Cap Funds</strong></p>
          <p>Invest in the next set of growing companies.</p>
          <ul className="pl-6 list-none space-y-1"><li>✔ Higher growth potential</li><li>✔ Moderate risk</li></ul>
          <p><strong>c) Small-Cap Funds</strong></p>
          <p>Invest in young, fast-growing companies.</p>
          <ul className="pl-6 list-none space-y-1"><li>✔ Highest potential returns</li><li>✔ Highest volatility</li><li>✔ Only for long-term investors (7+ years)</li></ul>
          <p><strong>d) Multi-Cap / Flexi-Cap Funds</strong></p>
          <p>Mix of large, mid, and small caps.</p>
          <ul className="pl-6 list-none space-y-1"><li>✔ Diversified</li><li>✔ Great for beginners</li><li>✔ Balanced risk-return</li></ul>
          <p><strong>e) Sectoral / Thematic Funds</strong></p>
          <p>Focus on one industry like IT, Pharma, Banking, Energy.</p>
          <ul className="pl-6 list-none space-y-1"><li>✔ High risk (because all money is in one sector)</li><li>✔ Only when you strongly believe in that sector</li></ul>
          ...
          <ul className="pl-6 list-disc space-y-1"><li>Government bonds</li><li>Corporate bonds</li><li>Money market instruments</li></ul>
          <p>They aim for <strong>steady but moderate returns</strong>, with much lower volatility.</p>
          <p><strong>Best for:</strong></p>
          <ul className="pl-6 list-disc space-y-1"><li>Short-term goals (0–3 years)</li><li>Emergency funds</li><li>People who want stability</li></ul>
          ...
          <p>Debt funds won&apos;t make you rich quickly, but they will <strong>protect your capital</strong>.</p>

          <h3>3. Hybrid Funds — The Best of Both Worlds</h3>
          <p>These funds invest in both <strong>equity (for growth)</strong> and <strong>debt (for stability)</strong>.</p>
          <p>Hybrid funds are perfect for someone who wants balance.</p>
          <p><strong>Types:</strong></p>
          <p><strong>a) Aggressive Hybrid Funds</strong></p>
          <ul className="pl-6 list-none space-y-1"><li>~65–80% equity + rest in debt</li><li>✔ More growth</li><li>✔ Moderate risk</li></ul>
          <p><strong>b) Balanced Hybrid Funds</strong></p>
          <ul className="pl-6 list-none space-y-1"><li>50% equity + 50% debt</li><li>✔ Ideal for medium-term goals</li></ul>
          <p><strong>c) Conservative Hybrid Funds</strong></p>
          <ul className="pl-6 list-none space-y-1"><li>Mostly debt + small equity portion</li><li>✔ Safer, stable</li><li>✔ Suited for low-risk investors</li></ul>
          <p>Hybrid funds = stability + growth in one basket.</p>

          <h3>4. Index Funds — Simple, Low-Cost, and Effective</h3>
          <p>Index funds don&apos;t try to &quot;beat&quot; the market. They simply <strong>copy</strong> a market index like:</p>
          <ul className="pl-6 list-disc space-y-1"><li>NIFTY 50</li><li>Sensex</li><li>NIFTY Next 50</li><li>NIFTY Midcap 150</li></ul>
          <p>This makes them:</p>
          <ul className="pl-6 list-none space-y-1"><li>✔ Low-cost</li><li>✔ Transparent</li><li>✔ Beginner-friendly</li><li>✔ Excellent for long-term compounding</li></ul>
          <p>Index funds are like taking a train that moves steadily with the market, no surprises, no trying to outsmart anyone.</p>

          <h3>5. ETFs — Exchange Traded Funds</h3>
          <p>ETFs are similar to index funds but are traded like stocks.</p>
          <ul className="pl-6 list-none space-y-1"><li>✔ Lower cost</li><li>✔ Good for long-term holding</li><li>✔ Best for people comfortable with stock-market apps</li></ul>
          <p>They can track:</p>
          <ul className="pl-6 list-disc space-y-1"><li>Equity indices</li><li>Gold</li><li>Debt</li><li>International markets</li></ul>
          ...
          <ul className="pl-6 list-none space-y-1"><li>✔ Protects against inflation</li><li>✔ Good diversifier</li></ul>
          <p><strong>International Funds</strong></p>
          <p>Invest in companies outside India — like Apple, Tesla, Google, Amazon.</p>
          <ul className="pl-6 list-none space-y-1"><li>✔ Global exposure</li><li>✔ Reduces country-specific risk</li><li>✔ Long-term growth potential</li></ul>

          <h3>7. Solution-Oriented Funds</h3>
          <p>Created for specific life goals:</p>
          <ul className="pl-6 list-disc space-y-1"><li>Retirement</li><li>Children&apos;s education</li><li>Long-term planning</li></ul>
          <p>These funds often have longer mandatory lock-in periods.</p>

          <h3>8. Fund of Funds (FoFs)</h3>
          <p>These funds invest in <strong>other mutual funds</strong> instead of directly in stocks or bonds.</p>
          <ul className="pl-6 list-none space-y-1"><li>✔ Simple</li><li>✔ Globally diversified options</li><li>✔ Good for beginners who want a ready-made portfolio</li></ul>
          ...
          <p>There is a mutual fund for every person, every dream, every timeline, and every level of experience.</p>
      ...
      kn: (
        <>
          <p>ಪ್ರತಿಯೊಂದು ಮ್ಯೂಚುಯಲ್ ಫಂಡ್‌ನ ಗುರಿ ಒಂದೇ: ನಿಮ್ಮ ಗುರಿ, ನಿಮ್ಮ ಸಮಯದ ಅವಧಿ, ಮತ್ತು ಅಪಾಯ ಸಹಿಸಿಕೊಳ್ಳುವ ನಿಮ್ಮ ಸಾಮರ್ಥ್ಯಕ್ಕೆ ತಕ್ಕಂತೆ ನಿಮ್ಮ ಹಣವನ್ನು ಬೆಳೆಸುವುದು.</p>
          <p>ಆದರೆ ಎಲ್ಲ ಮ್ಯೂಚುಯಲ್ ಫಂಡ್‌ಗಳೂ ಒಂದೇ ರೀತಿ ವರ್ತಿಸುವುದಿಲ್ಲ.</p>
          <p>ಕೆಲವು ವೇಗವಾಗಿ ಬೆಳೆಯುತ್ತವೆ, ಆದರೆ ತೀರ್ವವಾಗಿ ಏರಿಳಿಯುತ್ತವೆ. ಕೆಲವು ನಿಧಾನವಾಗಿ ಬೆಳೆಯುತ್ತವೆ, ಆದರೆ ಸ್ಥಿರವಾಗಿ ಉಳಿಯುತ್ತವೆ. ಕೆಲವು ಬೆಳವಣಿಗೆ ಮತ್ತು ಸುರಕ್ಷತೆ ಎರಡನ್ನೂ ಸಮತೋಲನದಲ್ಲಿ ಇಟ್ಟುಕೊಂಡಿರುತ್ತಾವೆ. ಕೆಲವು ಮಾರುಕಟ್ಟೆಯ ಹಾದಿಯನ್ನೇ ಅನುಸರಿಸುತ್ತವೆ. ಇನ್ನು ಕೆಲವು ಒಂದು ನಿರ್ದಿಷ್ಟ ವಿಷಯ ಅಥವಾ ಕ್ಷೇತ್ರವನ್ನು ಹಿಂಬಾಲಿಸುತ್ತಾವೆ.</p>
          ...
          <div className="ch-illustration"><img src="/mutual-funds-101/image5.png" alt="Four vehicles representing mutual fund types: sports car (Equity), bus (Debt), SUV (Hybrid), train (Index)" className="mx-auto max-w-sm w-full" /></div>

          <h3>೧. ಇಕ್ವಿಟಿ ಫಂಡ್‌ಗಳು — ದೀರ್ಘಕಾಲೀಕ ಬೆಳವಣಿಗೆಗಾಗಿ</h3>
          <p>ಈ ಫಂಡ್‌ಗಳು ಮುಖ್ಯವಾಗಿ ಷೇರುಗಳಲ್ಲಿ ಹೂಡಿಕೆ ಮಾಡುತ್ತವೆ. ಷೇರುಗಳ ಬೆಲೆ ಏರಿಳಿತಕ್ಕೆ ಒಳಗಾಗುವ ಕಾರಣ, ಇಕ್ವಿಟಿ ಫಂಡ್‌ಗಳು ಅಲ್ಪಾವಧಿಯಲ್ಲಿ ಮೇಲೆ-ಕೆಳಗೆ ಚಲಿಸಬಹುದು. ಆದಾಗ್ಯೂ, ಐತಿಹಾಸಿಕ ದಾಖಲೆಗಳ ಪ್ರಕಾರ, ದೀರ್ಘಕಾಲದಲ್ಲಿ ಅತ್ಯಧಿಕ ಸಂಪತ್ತು ನಿರ್ಮಿಸುತ್ತವೆ.</p>
          <p><strong>ಇಕ್ವಿಟಿ ಫಂಡ್ ಯಾವಾಗ ಆರಿಸಬೇಕು?</strong></p>
          <ul className="pl-6 list-disc space-y-1"><li>ನಿಮ್ಮ ಗುರಿ ೫ ವರ್ಷಗಳಿಗಿಂತ ದೂರದಲ್ಲಿದ್ದರೆ</li><li>ದೀರ್ಘಕಾಲ ಅವಧಿಯಲ್ಲಿ ಉತ್ತಮ ಆದಾಯ ಬಯಸುತ್ತಿದ್ದರೆ</li><li>ಅಲ್ಪಾವಧಿಯ ಏರಿಳಿತವನ್ನು ತಾಳ್ಮೆಯಿಂದ ನಿರ್ವಹಿಸಬಲ್ಲಿರಾದರೆ</li></ul>
          ...
          <ul className="pl-6 list-none space-y-1"><li>✔ ಇತರ ಇಕ್ವಿಟಿ ವಿಧಗಳಿಗೆ ಹೋಲಿಸಿದರೆ ಕಡಿಮೆ ಅಪಾಯ</li><li>✔ ಹೊಸ ಹೂಡಿಕೆದಾರರಿಗೆ ಸೂಕ್ತ</li><li>✔ ಸ್ಥಿರವಾದ ಸಾಧನೆ</li></ul>
          <p><strong>ಆ) ಮಿಡ್-ಕ್ಯಾಪ್ ಫಂಡ್‌ಗಳು</strong></p>
          <p>ಬೆಳೆಯುತ್ತಿರುವ ಮುಂದಿನ ಹಂತದ ಕಂಪನಿಗಳಲ್ಲಿ ಹೂಡಿಕೆ ಮಾಡುತ್ತವೆ.</p>
          <ul className="pl-6 list-none space-y-1"><li>✔ ಹೆಚ್ಚಿನ ಬೆಳವಣಿಗೆಯ ಸಾಧ್ಯತೆ</li><li>✔ ಮಧ್ಯಮ ಅಪಾಯ</li></ul>
          <p><strong>ಇ) ಸ್ಮಾಲ್-ಕ್ಯಾಪ್ ಫಂಡ್‌ಗಳು</strong></p>
          <p>ಚಿಕ್ಕ, ವೇಗವಾಗಿ ಬೆಳೆಯುತ್ತಿರುವ ಕಂಪನಿಗಳಲ್ಲಿ ಹೂಡಿಕೆ ಮಾಡುತ್ತವೆ.</p>
          <ul className="pl-6 list-none space-y-1"><li>✔ ಅತ್ಯಧಿಕ ಆದಾಯದ ಸಾಧ್ಯತೆ</li><li>✔ ಅತ್ಯಧಿಕ ಏರಿಳಿತ</li><li>✔ ದೀರ್ಘಕಾಲೀಕ ಹೂಡಿಕೆದಾರರಿಗೆ ಮಾತ್ರ (೭+ ವರ್ಷಗಳು)</li></ul>
          <p><strong>ಈ) ಮಲ್ಟಿ-ಕ್ಯಾಪ್ / ಫ್ಲೆಕ್ಸಿ-ಕ್ಯಾಪ್ ಫಂಡ್‌ಗಳು</strong></p>
          <p>ಲಾರ್ಜ್, ಮಿಡ್ ಮತ್ತು ಸ್ಮಾಲ್ ಕ್ಯಾಪ್‌ಗಳ ಮಿಶ್ರಣ.</p>
          <ul className="pl-6 list-none space-y-1"><li>✔ ವೈವಿಧ್ಯೀಕೃತ</li><li>✔ ಆರಂಭಿಕರಿಗೆ ಅತ್ಯುತ್ತಮ</li><li>✔ ಸಮತೋಲಿತ ಅಪಾಯ-ಆದಾಯ</li></ul>
          ...
          <ul className="pl-6 list-none space-y-1"><li>✔ ಹೆಚ್ಚಿನ ಅಪಾಯ (ಎಲ್ಲ ಹಣವೂ ಒಂದೇ ಕ್ಷೇತ್ರದಲ್ಲಿರುವ ಕಾರಣ)</li><li>✔ ಆ ಕ್ಷೇತ್ರದ ಬಗ್ಗೆ ದೃಢ ನಂಬಿಕೆ ಇದ್ದಾಗ ಮಾತ್ರ ಆರಿಸಬೇಕು</li></ul>
          ...
          <ul className="pl-6 list-disc space-y-1"><li>ಸರ್ಕಾರಿ ಬಾಂಡ್‌ಗಳಲ್ಲಿ</li><li>ಕಾರ್ಪೊರೇಟ್ ಬಾಂಡ್‌ಗಳಲ್ಲಿ</li><li>ಹಣದ ಮಾರುಕಟ್ಟೆ ಸಾಧನಗಳಲ್ಲಿ</li></ul>
          <p>ಇವು ಕಡಿಮೆ ಏರಿಳಿತದೊಂದಿಗೆ ಸ್ಥಿರ ಆದರೆ ಮಧ್ಯಮ ಆದಾಯವನ್ನು ಗುರಿಯಾಗಿಟ್ಟುಕೊಳ್ಳುತ್ತವೆ.</p>
          <p><strong>ಯಾರಿಗೆ ಸೂಕ್ತ:</strong></p>
          <ul className="pl-6 list-disc space-y-1"><li>ಅಲ್ಪಾವಧಿ ಗುರಿಗಳಿಗೆ (೦–೩ ವರ್ಷ)</li><li>ತುರ್ತು ನಿಧಿಗಾಗಿ</li><li>ಸ್ಥಿರತೆ ಬಯಸುವವರಿಗೆ</li></ul>
          ...
          <p>ಈ ಫಂಡ್‌ಗಳು ಇಕ್ವಿಟಿ (ಬೆಳವಣಿಗೆಗಾಗಿ) ಮತ್ತು ಡೆಟ್ (ಸ್ಥಿರತೆಗಾಗಿ) ಎರಡರಲ್ಲೂ ಹೂಡಿಕೆ ಮಾಡುತ್ತವೆ. ಸಮತೋಲನ ಬಯಸುವವರಿಗೆ ಹೈಬ್ರಿಡ್ ಫಂಡ್‌ಗಳು ಅತ್ಯಂತ ಸೂಕ್ತ.</p>
          <p><strong>ವಿಧಗಳು:</strong></p>
          <p><strong>ಅ) ಅಗ್ರೆಸಿವ್ ಹೈಬ್ರಿಡ್ ಫಂಡ್‌ಗಳು</strong></p>
          <ul className="pl-6 list-none space-y-1"><li>~೬೫–೮೦% ಇಕ್ವಿಟಿ + ಉಳಿದದ್ದು ಡೆಟ್</li><li>✔ ಹೆಚ್ಚಿನ ಬೆಳವಣಿಗೆ</li><li>✔ ಮಧ್ಯಮ ಅಪಾಯ</li></ul>
          <p><strong>ಆ) ಬ್ಯಾಲೆನ್ಸ್ಡ್ ಹೈಬ್ರಿಡ್ ಫಂಡ್‌ಗಳು</strong></p>
          <ul className="pl-6 list-none space-y-1"><li>೫೦% ಇಕ್ವಿಟಿ + ೫೦% ಡೆಟ್</li><li>✔ ಮಧ್ಯಮಾವಧಿ ಗುರಿಗಳಿಗೆ ಸೂಕ್ತ</li></ul>
          <p><strong>ಇ) ಕನ್ಸರ್ವೇಟಿವ್ ಹೈಬ್ರಿಡ್ ಫಂಡ್‌ಗಳು</strong></p>
          <ul className="pl-6 list-none space-y-1"><li>ಹೆಚ್ಚಾಗಿ ಡೆಟ್ + ಸ್ವಲ್ಪ ಇಕ್ವಿಟಿ</li><li>✔ ಹೆಚ್ಚು ಸುರಕ್ಷಿತ, ಸ್ಥಿರ</li><li>✔ ಕಡಿಮೆ ಅಪಾಯ ಬಯಸುವ ಹೂಡಿಕೆದಾರರಿಗೆ ಸೂಕ್ತ</li></ul>
          ...
          <ul className="pl-6 list-disc space-y-1"><li>NIFTY 50</li><li>Sensex</li><li>NIFTY Next 50</li><li>NIFTY Midcap 150</li></ul>
          <p>ಇದರಿಂದ ಅವು:</p>
          <ul className="pl-6 list-none space-y-1"><li>✔ ಕಡಿಮೆ ವೆಚ್ಚದ್ದಾಗಿರುತ್ತವೆ</li><li>✔ ಪಾರದರ್ಶಕವಾಗಿರುತ್ತವೆ</li><li>✔ ಆರಂಭಿಕರಿಗೆ ಸ್ನೇಹಿ</li><li>✔ ದೀರ್ಘಕಾಲೀನ ಚಕ್ರಬಡ್ಡಿ ಬೆಳವಣಿಗೆಗೆ ಅತ್ಯುತ್ತಮ</li></ul>
          ...
          <ul className="pl-6 list-none space-y-1"><li>✔ ಕಡಿಮೆ ವೆಚ್ಚ</li><li>✔ ದೀರ್ಘಕಾಲೀಕ ಹಿಡುವಳಿಗೆ ಸೂಕ್ತ</li><li>✔ ಷೇರು ಮಾರುಕಟ್ಟೆ ಆಪ್‌ಗಳಲ್ಲಿ ಅನುಭವ ಇರುವವರಿಗೆ ಉತ್ತಮ</li></ul>
          <p>ಇವು ಅನುಸರಿಸಬಲ್ಲವು:</p>
          <ul className="pl-6 list-disc space-y-1"><li>ಇಕ್ವಿಟಿ ಸೂಚ್ಯಂಕಗಳನ್ನು</li><li>ಚಿನ್ನವನ್ನು</li><li>ಡೆಟ್ ಅನ್ನು</li><li>ಅಂತರರಾಷ್ಟ್ರೀಯ ಮಾರುಕಟ್ಟೆಗಳನ್ನು</li></ul>
          ...
          <ul className="pl-6 list-none space-y-1"><li>✔ ಹಣದುಬ್ಬರದ ವಿರುದ್ಧ ರಕ್ಷಣೆ</li><li>✔ ಉತ್ತಮ ವೈವಿಧ್ಯತೆಗೆ ಅನುವು ಗೊಳಿಸುತ್ತಾದೆ</li></ul>
          <p><strong>ಅಂತರರಾಷ್ಟ್ರೀಯ ಫಂಡ್‌ಗಳು</strong></p>
          <p>Apple, Tesla, Google, Amazon ನಂತಹ ಭಾರತದ ಹೊರಗಿನ ಕಂಪನಿಗಳಲ್ಲಿ ಹೂಡಿಕೆ ಮಾಡುತ್ತವೆ.</p>
          <ul className="pl-6 list-none space-y-1"><li>✔ ಜಾಗತಿಕ ಮರುಕಟ್ಟೆಗೆ ತೆರೆದು ಕೊಳ್ಳುವ</li><li>✔ ದೇಶ-ನಿರ್ದಿಷ್ಟ ಅಪಾಯ ಕಡಿಮೆಯಾಗುತ್ತದೆ</li><li>✔ ದೀರ್ಘಕಾಲೀಕ ಬೆಳವಣಿಗೆಯ ಸಾಧ್ಯತೆ</li></ul>

          <h3>೭. ಗುರಿ-ಆಧಾರಿತ ಫಂಡ್‌ಗಳು</h3>
          <p>ನಿರ್ದಿಷ್ಟ ಜೀವನ ಗುರಿಗಳಿಗಾಗಿ ರೂಪಿಸಲಾದ ಫಂಡ್‌ಗಳು:</p>
          <ul className="pl-6 list-disc space-y-1"><li>ನಿವೃತ್ತಿ</li><li>ಮಕ್ಕಳ ಶಿಕ್ಷಣ</li><li>ದೀರ್ಘಕಾಲೀಕ ಯೋಜನೆ</li></ul>
          ...
          <ul className="pl-6 list-none space-y-1"><li>✔ ಸರಳ</li><li>✔ ಜಾಗತಿಕ ವೈವಿಧ್ಯದ ಆಯ್ಕೆಗಳು</li><li>✔ ಸಿದ್ಧ ಪೋರ್ಟ್‌ಫೋಲಿಯೊ ಬಯಸುವ ಆರಂಭಿಕರಿಗೆ ಸೂಕ್ತ</li></ul>
          ...
          <p>ಪ್ರತಿಯೊಬ್ಬ ವ್ಯಕ್ತಿಗೂ, ಪ್ರತಿ ಕನಸಿಗೂ, ಪ್ರತಿ ಅವಧಿಗೂ, ಮತ್ತು ಪ್ರತಿ ಅನುಭವದ ಮಟ್ಟಕ್ಕೂ ತಕ್ಕ ಒಂದು ಮ್ಯೂಚುಯಲ್ ಫಂಡ್ ಇದ್ದೇ ಇದೆ.</p>

          <div className="ch-illustration"><img src="/mutual-funds-101/image2.png" alt="Different people at different life stages — student, young professional, middle-aged, retiree — each with their own financial goal" className="mx-auto max-w-sm w-full" /></div>
        </>
      ),
    },
  },
    ...
    content: {
      en: (
        <>
          ...
          <p><strong>Most people don&apos;t fail at investing because they choose the wrong fund&hellip;</strong></p>
          <p>They fail because they invest inconsistently.</p>
          <p>They invest when they feel confident. They stop when markets fall. They wait for &quot;the right moment&quot;, which usually never comes.</p>
          <p>SIPs solve this human problem beautifully.</p>
          <h3>1. So, What Exactly Is a SIP?</h3>
          <p>A <strong>SIP (Systematic Investment Plan)</strong> is a method of investing where you put in a fixed amount of money at regular intervals, usually monthly.</p>
          <p>Think of it like a subscription for your future.</p>
          <p>Just like you pay Netflix or your gym membership every month, with SIPs you pay <strong>yourself</strong> every month.</p>
          <ul className="pl-6 list-none space-y-1"><li>₹100</li><li>₹500</li><li>₹1,000</li><li>₹5,000</li></ul>
          <p>You choose the amount. You choose the date. Your money goes directly into a mutual fund automatically.</p>
          ...
          <p>Even ₹500 a month, when done consistently, grows into something powerful over time because of <strong>compounding</strong>, where your returns start earning returns.</p>
          ...
          <ul className="pl-6 list-none space-y-1"><li>When prices are high → your SIP buys fewer units.</li><li>When prices are low → your SIP buys more units.</li></ul>
          <p>Over time, this averages out your cost and reduces risk.</p>
          <p>You&apos;re not emotionally reacting to the market&hellip; You&apos;re mechanically accumulating wealth.</p>
          <h3>4. SIPs Build the Most Important Habit: Discipline</h3>
          <p>Let&apos;s be honest:</p>
          <p>Nobody becomes wealthy by investing once. People become wealthy by investing regularly.</p>
          <p>SIP forces consistency because:</p>
          <ul className="pl-6 list-disc space-y-1"><li>It runs automatically</li><li>You don&apos;t have to remember dates</li><li>You don&apos;t have to time the market</li><li>You don&apos;t have to worry about short-term noise</li></ul>
          ...
          <ul className="pl-6 list-disc space-y-1"><li>Fear when markets fall</li><li>Greed when markets rise</li><li>Anxiety when there&apos;s bad news</li><li>Overconfidence when there&apos;s good news</li></ul>
          <p>These emotions make people buy high and sell low, the exact opposite of what creates wealth.</p>
          <p>SIPs remove emotion completely.</p>
          <ul className="pl-6 list-none space-y-1"><li>You invest on the good days.</li><li>You invest on the bad days.</li><li>You invest on the boring days.</li><li>You invest during market crashes too.</li></ul>
          <p>Over time, your wealth grows&hellip; while your mind stays calm.</p>
          <h3>6. SIPs Fit Every Goal, Every Income, Every Investor</h3>
          <p>Whether you&apos;re a student, a young professional, a parent, or nearing retirement, there is a SIP for every need:</p>
          <ul className="pl-6 list-disc space-y-1"><li>Saving for travel</li><li>Building an emergency fund</li><li>Buying a bike or car</li><li>Saving for a house</li><li>Retirement planning</li><li>Children&apos;s education</li><li>Long-term wealth creation</li></ul>
          ...
          <ul className="pl-6 list-disc space-y-1"><li>Equity funds</li><li>Debt funds</li><li>Hybrid funds</li><li>Index funds</li><li>International funds</li><li>Gold funds</li></ul>
          <div className="pull-quote">SIP is just the <strong>fuel</strong>, the fund you choose is the <strong>vehicle</strong>.</div>
          <h3>8. SIPs Are the Easiest Way for Anyone to Start Investing</h3>
          <p>The best part?</p>
          <p>You don&apos;t need:</p>
          <ul className="pl-6 list-disc space-y-1"><li>Market knowledge</li><li>Financial expertise</li><li>Perfect timing</li><li>Large capital</li><li>Active monitoring</li></ul>
          <p>SIPs are designed to make investing simple, steady, and stress-free.</p>
          <p>They help beginners behave like long-term investors, even if they don&apos;t understand every detail of the market.</p>
          <p><strong>In short: SIPs are not just a tool&hellip;</strong></p>
          <p>They are a powerful habit that transforms ordinary people into disciplined wealth builders.</p>
          <ul className="pl-6 list-none space-y-1"><li>They make volatility irrelevant.</li><li>They make timing unnecessary.</li><li>They make growth automatic.</li></ul>
          <p>This is why everyone talks about SIPs, <strong>because SIPs work.</strong></p>
          <div className="ch-illustration"><img src="/mutual-funds-101/image6.png" alt="A person dropping a coin into a SIP pot, with a rising stack of coins showing wealth growing over time" className="mx-auto max-w-xs w-full" /></div>
        </>
      ),
      kn: (
        <>
          <p>SIP ಅರ್ಥಮಾಡಿಕೊಳ್ಳುವ ಮುನ್ನ, ಒಂದು ಸರಳ ಸತ್ಯವನ್ನು ಗಮನಿಸೋಣ:</p>
          <p>ಹೆಚ್ಚಿನ ಜನರು ಹೂಡಿಕೆಯಲ್ಲಿ ವಿಫಲವಾಗುವುದು ತಪ್ಪು ಫಂಡ್ ಆರಿಸಿದ ಕಾರಣದಿಂದಲ್ಲ... ಅವರು ನಿರಂತರವಾಗಿ ಹೂಡಿಕೆ ಮಾಡದೆ ಇರುವ ಕಾರಣದಿಂದ.</p>
          <p>ಆತ್ಮವಿಶ್ವಾಸವಿದ್ದಾಗ ಮಾತ್ರ ಹೂಡಿಕೆ ಮಾಡುತ್ತಾರೆ. ಮಾರುಕಟ್ಟೆ ಕುಸಿದಾಗ ನಿಲ್ಲಿಸಿಬಿಡುತ್ತಾರೆ. &quot;ಸರಿಯಾದ ಕ್ಷಣ&quot; ಬರಲಿ ಎಂದು ಕಾಯುತ್ತಾರೆ — ಅದು ಸಾಮಾನ್ಯವಾಗಿ ಎಂದಿಗೂ ಬರುವುದಿಲ್ಲ.</p>
          <p>SIP ಈ ಮಾನವ ಸ್ವಭಾವದ ಸಮಸ್ಯೆಯನ್ನು ಬಹಳ ಸೊಗಸಾಗಿ ಪರಿಹರಿಸುತ್ತದೆ.</p>
          <h3>೧. ಹಾಗಾದರೆ SIP ಎಂದರೆ ನಿಖರವಾಗಿ ಏನು?</h3>
          <p>SIP (Systematic Investment Plan) ಎಂದರೆ ನಿಗದಿತ ಸಮಯದ ಅಂತರಗಳಲ್ಲಿ — ಸಾಮಾನ್ಯವಾಗಿ ತಿಂಗಳಿಗೊಮ್ಮೆ — ನಿಗದಿತ ಮೊತ್ತವನ್ನು ಹೂಡಿಕೆ ಮಾಡುವ ಒಂದು ವಿಧಾನ.</p>
          <p>ಇದನ್ನು ನಿಮ್ಮ ಭವಿಷ್ಯಕ್ಕಾಗಿ ಚಂದಾ ಕಟ್ಟಿದಂತೆ ಎಂದು ಯೋಚಿಸಿ.</p>
          <p>Netflix ಅಥವಾ ಜಿಮ್ ಸದಸ್ಯತ್ವಕ್ಕೆ ತಿಂಗಳಿಗೊಮ್ಮೆ ಹಣ ನೀಡುವಂತೆ, SIP ಮೂಲಕ ನೀವು ಪ್ರತಿ ತಿಂಗಳು ನಿಮಗೇ ನೀವು ಹಣ ನೀಡುತ್ತೀರಿ.</p>
          <ul className="pl-6 list-none space-y-1"><li>₹೧೦೦</li><li>₹೫೦೦</li><li>₹೧,೦೦೦</li><li>₹೫,೦೦೦</li></ul>
          <p>ಮೊತ್ತ ನೀವು ನಿರ್ಧರಿಸುತ್ತೀರಿ. ದಿನಾಂಕ ನೀವು ಆರಿಸುತ್ತೀರಿ. ಹಣ ನೇರವಾಗಿ ಮ್ಯೂಚುಯಲ್ ಫಂಡ್‌ಗೆ ಯಾಂತ್ರಿಕವಾಗಿ ತಾನಾಗಿಯೇ ತೆರಳುತ್ತದೆ. ಈ ನಿರಂತರತೆ ಶ್ರಮರಹಿತವಾಗುತ್ತದೆ.</p>
          <h3>೨. SIP ಚಿಕ್ಕ ಹಣವನ್ನು ದೊಡ್ಡ ಸಂಪತ್ತನ್ನಾಗಿ ಪರಿವರ್ತಿಸುತ್ತದೆ</h3>
          <p>ಪ್ರಾರಂಭಿಸಲು ದೊಡ್ಡ ಮೊತ್ತ ಬೇಕಿಲ್ಲ.</p>
          <p>ತಿಂಗಳಿಗೆ ಕೇವಲ ₹೫೦೦ ಸಹ, ನಿಯಮಿತವಾಗಿ ಹೂಡಿದರೆ, ಕಾಲಕ್ರಮೇಣ ಚಕ್ರಬಡ್ಡಿಯ ಮೂಲಕ ಶಕ್ತಿಶಾಲಿಯಾಗಿ ಬೆಳೆಯುತ್ತದೆ — ನಿಮ್ಮ ಆದಾಯವು ತಾನೇ ಆದಾಯ ಗಳಿಸಲು ಆರಂಭಿಸುತ್ತದೆ.</p>
          ...
          <ul className="pl-6 list-none space-y-1"><li>ಬೆಲೆ ಹೆಚ್ಚಿದ್ದಾಗ → ನಿಮ್ಮ SIP ಕಡಿಮೆ ಘಟಕಗಳನ್ನು ಖರೀದಿಸುತ್ತದೆ.</li><li>ಬೆಲೆ ಕಡಿಮೆಯಿದ್ದಾಗ → ನಿಮ್ಮ SIP ಹೆಚ್ಚು ಘಟಕಗಳನ್ನು ಖರೀದಿಸುತ್ತದೆ.</li></ul>
          ...
          <ul className="pl-6 list-disc space-y-1"><li>ಅದು ಯಾಂತ್ರಿಕವಾಗಿ ತಾನಾಗಿಯೇ ನಡೆಯುತ್ತದೆ</li><li>ದಿನಾಂಕವನ್ನು ನೆನಪಿಡಬೇಕಿಲ್ಲ</li><li>ಮಾರುಕಟ್ಟೆಯನ್ನು ನೋಡಬೇಕಿಲ್ಲ</li><li>ಅಲ್ಪಾವಧಿ ಗದ್ದಲದ ಬಗ್ಗೆ ಚಿಂತಿಸಬೇಕಿಲ್ಲ</li></ul>
          <p>ಕ್ರಮಬದ್ಧವಾಗಿ ವ್ಯಾಯಾಮಶಾಲೆಗೆ ಹೋಗುವುದಕ್ಕೆ ಇದು ಆರ್ಥಿಕ ಸಮಾನಾಂತರ. ಚಿಕ್ಕ ಪುಟ್ಟ ಪ್ರಯತ್ನಗಳು ಒಟ್ಟಾಗಿ ಬೃಹತ್ ಬದಲಾವಣೆಯನ್ನು ತರುತ್ತವೆ.</p>
          <h3>೫. SIP ಭಾವನಾತ್ಮಕ ಹೂಡಿಕೆಯನ್ನು ತಡೆಯುತ್ತದೆ</h3>
          <p>ಹೂಡಿಕೆ ಭಾವನೆಗಳನ್ನು ಕೆರಳಿಸುತ್ತದೆ:</p>
          <ul className="pl-6 list-disc space-y-1"><li>ಮಾರುಕಟ್ಟೆ ಕುಸಿದಾಗ ಭಯ</li><li>ಮಾರುಕಟ್ಟೆ ಏರಿದಾಗ ದುರಾಸೆ</li><li>ಕೆಟ್ಟ ಸುದ್ದಿ ಬಂದಾಗ ಆತಂಕ</li><li>ಒಳ್ಳೆಯ ಸುದ್ದಿ ಬಂದಾಗ ಅತಿಯಾದ ಆತ್ಮವಿಶ್ವಾಸ</li></ul>
          ...
          <ul className="pl-6 list-none space-y-1"><li>ಒಳ್ಳೆಯ ದಿನಗಳಲ್ಲೂ ಹೂಡಿಕೆ ಮಾಡುತ್ತೀರಿ.</li><li>ಕೆಟ್ಟ ದಿನಗಳಲ್ಲೂ ಹೂಡಿಕೆ ಮಾಡುತ್ತೀರಿ.</li><li>ಸಾಧಾರಣ ದಿನಗಳಲ್ಲೂ ಹೂಡಿಕೆ ಮಾಡುತ್ತೀರಿ.</li><li>ಮಾರುಕಟ್ಟೆ ಕುಸಿತದ ಸಮಯದಲ್ಲೂ ಹೂಡಿಕೆ ಮಾಡುತ್ತೀರಿ.</li></ul>
          ...
          <p>ವಿದ್ಯಾರ್ಥಿಯಾಗಿರಲಿ, ಯುವ ವೃತ್ತಿಪರರಾಗಿರಲಿ, ಪೋಷಕರಾಗಿರಲಿ, ಅಥವಾ ನಿವೃತ್ತಿಯ ಅಂಚಿನಲ್ಲಿರಲಿ — ಪ್ರತಿ ಅಗತ್ಯಕ್ಕೂ ಒಂದು SIP ಇದೆ:</p>
          <ul className="pl-6 list-disc space-y-1"><li>ಪ್ರಯಾಣಕ್ಕಾಗಿ ಉಳಿತಾಯ</li><li>ತುರ್ತು ನಿಧಿ ನಿರ್ಮಾಣ</li><li>ದ್ವಿಚಕ್ರ ವಾಹನ ಅಥವಾ ಕಾರು ಖರೀದಿ</li><li>ಮನೆಗಾಗಿ ಉಳಿತಾಯ</li><li>ನಿವೃತ್ತಿ ಯೋಜನೆ</li><li>ಮಕ್ಕಳ ಶಿಕ್ಷಣ</li><li>ದೀರ್ಘಕಾಲೀಕ ಸಂಪತ್ತು ನಿರ್ಮಾಣ</li></ul>
          <p>ನಿಮ್ಮ ಆದಾಯ ಬದಲಾಗಬಹುದು, ಆದರೆ ಅದಕ್ಕೆ ತಕ್ಕಂತೆ ನಿಮ್ಮ SIP ಬದಲಾಗಬಲ್ಲದು. ಯಾವಾಗ ಬೇಕಾದರೂ ಮೊತ್ತ ಹೆಚ್ಚಿಸಬಹುದು, ಕಡಿಮೆ ಮಾಡಬಹುದು, ತಾತ್ಕಾಲಿಕವಾಗಿ ನಿಲ್ಲಿಸಬಹುದು, ಅಥವಾ ಮತ್ತೆ ಪ್ರಾರಂಭಿಸಬಹುದು.</p>
          ...
          <ul className="pl-6 list-disc space-y-1"><li>ಇಕ್ವಿಟಿ ಫಂಡ್‌ಗಳಲ್ಲಿ</li><li>ಡೆಟ್ ಫಂಡ್‌ಗಳಲ್ಲಿ</li><li>ಹೈಬ್ರಿಡ್ ಫಂಡ್‌ಗಳಲ್ಲಿ</li><li>ಇಂಡೆಕ್ಸ್ ಫಂಡ್‌ಗಳಲ್ಲಿ</li><li>ಅಂತರರಾಷ್ಟ್ರೀಯ ಫಂಡ್‌ಗಳಲ್ಲಿ</li><li>ಗೋಲ್ಡ್ ಫಂಡ್‌ಗಳಲ್ಲಿ</li></ul>
          <div className="pull-quote">SIP ಕೇವಲ <strong>ಇಂಧನ</strong> — ನೀವು ಆರಿಸಿಕೊಳ್ಳುವ ಫಂಡ್ <strong>ವಾಹನ</strong>.</div>
          <h3>೮. SIP ಯಾರಿಗಾದರೂ ಹೂಡಿಕೆ ಆರಂಭಿಸಲು ಅತ್ಯಂತ ಸುಲಭ ಮಾರ್ಗ</h3>
          <p>ಅತ್ಯುತ್ತಮ ಅಂಶ ಏನೆಂದರೆ — ನಿಮಗೆ ಇವ್ಯಾವುದೂ ಬೇಕಿಲ್ಲ:</p>
          <ul className="pl-6 list-disc space-y-1"><li>ಮಾರುಕಟ್ಟೆ ಜ್ಞಾನ</li><li>ಆರ್ಥಿಕ ಪರಿಣತಿ</li><li>ಸೂಕ್ತ ಸಮಯ</li><li>ದೊಡ್ಡ ಬಂಡವಾಳ</li><li>ನಿರಂತರ ಮೇಲ್ವಿಚಾರಣೆ</li></ul>
          <p>ಹೂಡಿಕೆಯನ್ನು ಸರಳ, ಸ್ಥಿರ ಮತ್ತು ನಿಶ್ಚಿಂತೆಯ ಅನುಭವವನ್ನಾಗಿ ಮಾಡಲು SIP ಗಳನ್ನು ವಿನ್ಯಾಸಗೊಳಿಸಲಾಗಿದೆ. ಮಾರುಕಟ್ಟೆಯ ಪ್ರತಿ ವಿವರ ತಿಳಿಯದಿದ್ದರೂ, ಹೊಸಬರು ದೀರ್ಘಕಾಲೀಕ ಹೂಡಿಕೆದಾರರಂತೆ ವರ್ತಿಸಲು ಸಹಾಯ ಮಾಡುತ್ತವೆ.</p>
          <p><strong>ಸಂಕ್ಷಿಪ್ತವಾಗಿ ಹೇಳುವುದಾದರೆ: SIP ಕೇವಲ ಒಂದು ಸಾಧನವಲ್ಲ...</strong></p>
          <p>ಇದು ಸಾಮಾನ್ಯ ಜನರನ್ನು ಶಿಸ್ತಿನ ಸಂಪತ್ತು ನಿರ್ಮಾತೃಗಳನ್ನಾಗಿ ಪರಿವರ್ತಿಸುವ ಒಂದು ಶಕ್ತಿಶಾಲಿ ಅಭ್ಯಾಸ.</p>
          <ul className="pl-6 list-none space-y-1"><li>ಏರಿಳಿತವನ್ನು ಅಪ್ರಸ್ತುತಗೊಳಿಸುತ್ತದೆ.</li><li>ಸಮಯವನ್ನು ಅನಾವಶ್ಯಕಗೊಳಿಸುತ್ತದೆ.</li><li>ಬೆಳವಣಿಗೆಯನ್ನು ಸ್ವಯಂಚಾಲಿತಗೊಳಿಸುತ್ತದೆ.</li></ul>
    ...
    content: {
      en: (
        <>
          ...
          <ul className="pl-6 list-disc space-y-1"><li>What mutual funds are</li><li>Why diversification reduces risk</li><li>The different types of funds</li><li>How SIP builds discipline and long-term wealth</li></ul>
          <p>That&apos;s the foundation.</p>
          <p>But knowing about mutual funds is only the first step.</p>
          <p>Wealth is created not by knowing more but by investing consistently and staying disciplined.</p>
          <p>Not all mutual funds are the same. Two funds in the same category can behave very differently.</p>
          <p>So the real question becomes:</p>
          <p><strong>How do you choose the right mutual fund for your goal?</strong></p>
          <p>In the next module, we move from understanding mutual funds to learning <strong>what to look at before choosing one</strong>, the key factors, numbers, and filters that help you select the right fund with clarity and confidence.</p>
          <div className="ch-illustration"><img src="/mutual-funds-101/image4.png" alt="A person looking at rows of mutual fund options — Fund A, Fund B, Fund C — ready to choose" className="mx-auto max-w-sm w-full" /></div>
        </>
      ),
      kn: (
        <>
          <p>ಈಗ ನೀವು ಈ ಕೆಳಗಿನವುಗಳನ್ನು ಅರ್ಥಮಾಡಿಕೊಂಡಿದ್ದೀರಿ:</p>
          <ul className="pl-6 list-disc space-y-1"><li>ಮ್ಯೂಚುಯಲ್ ಫಂಡ್ ಎಂದರೇನು</li><li>ವೈವಿಧ್ಯಮಯ ಹೂಡಿಕೆ ಅಪಾಯವನ್ನು ಹೇಗೆ ಕಡಿಮೆ ಮಾಡುತ್ತದೆ</li><li>ಫಂಡ್‌ಗಳ ವಿವಿಧ ವಿಧಗಳು</li><li>SIP ಶಿಸ್ತನ್ನು ಮತ್ತು ದೀರ್ಘಕಾಲೀಕ ಸಂಪತ್ತನ್ನು ಹೇಗೆ ನಿರ್ಮಿಸುತ್ತದೆ</li></ul>
          <p>ಇದು ಅಡಿಪಾಯ.</p>
          <p>ಆದರೆ ಮ್ಯೂಚುಯಲ್ ಫಂಡ್‌ಗಳ ಬಗ್ಗೆ ತಿಳಿದುಕೊಳ್ಳುವುದು ಮೊದಲ ಹೆಜ್ಜೆ ಮಾತ್ರ.</p>
          <p>ಸಂಪತ್ತು ನಿರ್ಮಾಣವಾಗುವುದು ಹೆಚ್ಚು ತಿಳಿದುಕೊಳ್ಳುವುದರಿಂದಲ್ಲ — ಕ್ರಮಬದ್ಧವಾಗಿ ಹೂಡಿಕೆ ಮಾಡುತ್ತ, ಶಿಸ್ತು ಕಾಪಾಡಿಕೊಳ್ಳುವುದರಿಂದ.</p>
          <p>ಎಲ್ಲ ಮ್ಯೂಚುಯಲ್ ಫಂಡ್‌ಗಳೂ ಒಂದೇ ರೀತಿ ಇರುವುದಿಲ್ಲ. ಒಂದೇ ವರ್ಗದ ಎರಡು ಫಂಡ್‌ಗಳು ಸಂಪೂರ್ಣ ಭಿನ್ನವಾಗಿ ವರ್ತಿಸಬಹುದು.</p>
          <p>ಹಾಗಾದರೆ ನಿಜವಾದ ಪ್ರಶ್ನೆ ಇದು:</p>
          <p><strong>ನಿಮ್ಮ ಗುರಿಗೆ ತಕ್ಕ ಸರಿಯಾದ ಮ್ಯೂಚುಯಲ್ ಫಂಡ್ ಅನ್ನು ಹೇಗೆ ಆರಿಸಬೇಕು?</strong></p>
          <p>ಮುಂದಿನ ಅಧ್ಯಾಯದಲ್ಲಿ, ಮ್ಯೂಚುಯಲ್ ಫಂಡ್‌ಗಳನ್ನು ಅರ್ಥಮಾಡಿಕೊಳ್ಳುವುದರಿಂದ ಮುಂದೆ ಸಾಗಿ — ಒಂದು ಫಂಡ್ ಆರಿಸುವ ಮುನ್ನ ಯಾವ ಅಂಶಗಳನ್ನು ಗಮನಿಸಬೇಕು ಎಂಬುದನ್ನು ಕಲಿಯುತ್ತೇವೆ. ಸ್ಪಷ್ಟತೆ ಮತ್ತು ಆತ್ಮವಿಶ್ವಾಸದಿಂದ ಸರಿಯಾದ ಫಂಡ್ ಆರಿಸಲು ನೆರವಾಗುವ ಪ್ರಮುಖ ಅಂಶಗಳು, ಸಂಖ್ಯೆಗಳು ಮತ್ತು ಸೋಸುವ ಮಾನದಂಡಗಳನ್ನು ಅಲ್ಲಿ ವಿವರಿಸಲಾಗುವುದು.</p>
          <div className="ch-illustration"><img src="/mutual-funds-101/image4.png" alt="A person looking at rows of mutual fund options — Fund A, Fund B, Fund C — ready to choose" className="mx-auto max-w-sm w-full" /></div>
        </>
      ),
    },
