...
/* =================================================================
   PLACEHOLDER CHAPTER COMPONENTS — EN
   ================================================================= */
...
/* =================================================================
   PLACEHOLDER CHAPTER COMPONENTS — KN (Kannada)
   ================================================================= */

const ChapterOneKn = () => (
  <p className="text-sm text-yellow-600/60 italic">
    [ಅಧ್ಯಾಯ 1 ವಿಷಯ: ನಿವ್ವಳ ಮೌಲ್ಯ ಚಿಂತನೆ — ಆಸ್ತಿಗಳು, ಹೊಣೆಗಾರಿಕೆಗಳು ಮತ್ತು ನಗದು ಹರಿವು — ಶೀಘ್ರದಲ್ಲೇ ಬರಲಿದೆ]
  </p>
);
...
const ChapterNineKn = () => (
  <p className="text-sm text-yellow-600/60 italic">
    [ಅಧ್ಯಾಯ 9 ವಿಷಯ: ಪೊಸಿಷನ್ ಸೈಜಿಂಗ್ — ಬಂಡವಾಳ ಹಂಚಿಕೆ — ಶೀಘ್ರದಲ್ಲೇ ಬರಲಿದೆ]
  </p>
);

const ChapterTenKn = () => (
  <p className="text-sm text-yellow-600/60 italic">
    [ಅಧ್ಯಾಯ 10 ವಿಷಯ: ಪೋರ್ಟ್‌ಫೋಲಿಯೊ ಮರು-ಸಮತೋಲನ — ನಿಮ್ಮ ಹಣಕಾಸಿನ ರಚನೆ ನಿರ್ವಹಣೆ — ಶೀಘ್ರದಲ್ಲೇ ಬರಲಿದೆ]
  </p>
);

const ChapterElevenKn = () => (
  <p className="text-sm text-yellow-600/60 italic">
    [ಅಧ್ಯಾಯ 11 ವಿಷಯ: ಏಕ ಮೊತ್ತ ಮತ್ತು SIP ಹೂಡಿಕೆ — ಶೀಘ್ರದಲ್ಲೇ ಬರಲಿದೆ]
  </p>
);

const ChapterTwelveKn = () => (
  <p className="text-sm text-yellow-600/60 italic">
    [ಅಧ್ಯಾಯ 12 ವಿಷಯ: ವರ್ತನಾ ಹಣಕಾಸು — ಹೂಡಿಕೆಯ ಮನೋವಿಜ್ಞಾನ — ಶೀಘ್ರದಲ್ಲೇ ಬರಲಿದೆ]
  </p>
);
...
const chapters = [
  ...
  },
  {
    ...
    content: { en: <ChapterElevenEn />, kn: <ChapterElevenKn /> },
  },
  {
    title: {
    ...
    content: { en: <ChapterTwelveEn />, kn: <ChapterTwelveKn /> },
  },
];
        ...
        <div className="complete-body">
          <div className="complete-inner">
            ...
            <p className="complete-sub">
              {lang === "kn"
                ? "ನೀವು Portfolio Construction & Wealth Strategy ಪೂರ್ಣಗೊಳಿಸಿದ್ದೀರಿ — ಎಲ್ಲಾ " + chapters.length + " ಅಧ್ಯಾಯಗಳು. ನಿವ್ವಳ ಮೌಲ್ಯ ಚಿಂತನೆಯಿಂದ ವರ್ತನಾ ಹಣಕಾಸಿನವರೆಗೆ, ನಿಮ್ಮ ಸಂಪತ್ತನ್ನು ರಚಿಸಲು ಮತ್ತು ನಿರ್ವಹಿಸಲು ನಿಮಗೆ ಸ್ಪಷ್ಟ ಚೌಕಟ್ಟು ಇದೆ."
                : "You\u2019ve finished Portfolio Construction & Wealth Strategy \u2014 all " + chapters.length + " chapters. From net worth thinking to behavioral finance, you now have a clear framework to build and manage your wealth."}
            </p>
