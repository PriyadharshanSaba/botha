...
export default function PortfolioConstructionPage() {
  ...
  const chapters = [
      ...
      content: (
        <>
          <p className="subtitle" style={{ fontSize: 18, color: "#666", lineHeight: 1.7 }}>
            Knowledge alone is not enough. This module shows you how to apply everything you have learned &mdash; building a structured, practical framework for managing your personal wealth through asset allocation, diversification, risk management and behavioral discipline.
          </p>
        </>
      ),
    },
    ...
    // ==============================
    {
      title: "Chapter 1: Net Worth Thinking &mdash; Assets, Liabilities & Cash Flow",
      content: (
        <>
          <p>This module shifts the focus from simply analyzing investments to structuring your entire financial life. Up to this point in the course, you have already built a strong foundation &mdash; you understand how markets work, how mutual funds function, how to read price behavior through technical analysis, and how to evaluate businesses using fundamental analysis.</p>
    ...
    // ==============================
    {
      ...
      content: (
        <>
          ...
          <blockquote className="pull-quote">Investing is personal. The right strategy is not the most popular one &mdash; it is the one that fits your life, your responsibilities and your long-term goals.</blockquote>
        </>
      ),
    },
    ...
    // ==============================
    {
      ...
      content: (
        <>
          ...
          <p><strong>Risk appetite</strong> refers to your emotional tolerance for volatility. It reflects how comfortable you feel when markets fluctuate and when the value of your investments temporarily declines. Some investors are comfortable seeing their portfolio fall 20&ndash;30% during market corrections if they believe in the long-term potential of their investments. Others may find even small fluctuations stressful.</p>
          ...
          <blockquote className="pull-quote">By understanding the difference between risk appetite and risk capacity, you can design an investment approach that is both financially sustainable and psychologically comfortable &mdash; helping you stay disciplined during inevitable market fluctuations.</blockquote>
        </>
      ),
    },
    ...
    // ==============================
    {
      title: "Chapter 4: Emergency Fund &mdash; Your Financial Safety Net",
      content: (
        <>
          ...
          <p>Without an emergency fund, investors may be forced to liquidate long-term investments during unfavorable market conditions simply to meet short-term financial needs. Selling investments during a market downturn locks in losses that would otherwise have recovered over time &mdash; exactly the opposite of what long-term investing requires.</p>
          <hr className="chapter-rule" />
          ...
          <blockquote className="pull-quote">An emergency fund is not an investment &mdash; it is insurance. It protects your long-term investments by ensuring you never need to sell them at the wrong time.</blockquote>
        </>
      ),
    },
    ...
    // ==============================
    {
      ...
      content: (
        <>
          ...
          <p>Short-term goals (1&ndash;3 years) typically require more stable and liquid investments. Medium-term goals (3&ndash;7 years) may involve a balanced mix of growth and stability. Long-term goals (10+ years) can often tolerate greater exposure to equities because there is more time to navigate market cycles.</p>
          <hr className="chapter-rule" />
          ...
          <blockquote className="pull-quote">By combining age and goal perspectives, investors can build portfolios that remain aligned with both life stages and financial priorities &mdash; creating a more balanced and sustainable investment strategy over time.</blockquote>
        </>
      ),
    },
    ...
    // ==============================
    {
      title: "Chapter 7: Asset Allocation &mdash; The Core Driver of Returns",
      content: (
        <>
          ...
          <p>Common asset classes include: <strong>Equities</strong> &mdash; stocks and equity mutual funds that offer long-term growth potential; <strong>Debt instruments</strong> &mdash; bonds, fixed deposits and debt mutual funds that provide stability and income; <strong>Gold</strong> &mdash; often used as a hedge during periods of economic uncertainty or inflation; and <strong>Real estate</strong> &mdash; property that may generate rental income and long-term capital appreciation. Each asset class behaves differently under various economic conditions.</p>
          ...
          <p>Consider two investors with ₹10 lakh available for investment. Investor A invests the entire amount in equities &mdash; while this portfolio may deliver strong returns during bull markets, it may also experience significant volatility during market corrections. Investor B spreads investments across multiple assets: ₹5 lakh in equities, ₹3 lakh in debt instruments, ₹1 lakh in gold and ₹1 lakh in other investments or cash reserves. In this case, the portfolio still participates in long-term equity growth but also includes assets that may provide stability during periods of market turbulence.</p>
          <hr className="chapter-rule" />
          <h3>Asset Allocation Changes Over Time</h3>
          <p>Asset allocation is not static &mdash; it often evolves as an investor&apos;s life circumstances change. A young professional may allocate 70&ndash;80% of their portfolio to equities because they have a long investment horizon. Someone approaching retirement may gradually shift toward a larger allocation in debt instruments and income-generating assets to reduce volatility. The primary goal of asset allocation is not simply maximizing returns &mdash; it is creating a portfolio that balances growth potential, risk management and financial stability.</p>
    ...
    // ==============================
    {
      title: "Chapter 8: Diversification &mdash; Managing Portfolio Risk",
      content: (
        <>
          <p>Diversification is one of the most important principles in long-term investing. It refers to spreading your investments across different assets so that no single investment has an outsized impact on your overall portfolio. Markets are inherently unpredictable &mdash; even strong companies, industries or asset classes may go through periods of weak performance. By diversifying, investors reduce the risk that a downturn in one investment will significantly damage their overall wealth.</p>
          <hr className="chapter-rule" />
    ...
    // ==============================
    {
      title: "Chapter 9: Position Sizing &mdash; Capital Allocation",
      content: (
        <>
          ...
          <p>Alternatively, some investors prefer a core-and-satellite approach, where larger positions (80&ndash;90% of the portfolio) are allocated to high-conviction investments while smaller allocations (10&ndash;20%) are made to exploratory opportunities.</p>
          <hr className="chapter-rule" />
          ...
          <blockquote className="pull-quote">You can find the right investment and still lose money by sizing it wrong. Position sizing is as important as stock selection &mdash; it determines how much each idea can help or hurt you.</blockquote>
        </>
      ),
    },
    ...
    // ==============================
    {
      title: "Chapter 10: Portfolio Rebalancing &mdash; Maintaining Your Financial Structure",
      content: (
        <>
          ...
          <p><strong>Periodic rebalancing</strong> is the most common approach &mdash; investors review and adjust their portfolios at regular intervals such as annually, semi-annually, or once every two to three years. For example, an investor may review their portfolio once a year and restore the original allocation if any asset class has deviated significantly from the target.</p>
          <p><strong>Systematic rebalancing</strong> involves making adjustments when allocations cross predefined thresholds rather than at fixed calendar intervals. For example, an investor may decide to rebalance whenever equity allocation moves more than 5&ndash;10% away from the target allocation. This method ensures that rebalancing occurs only when meaningful deviations arise, rather than strictly following a time schedule.</p>
          <hr className="chapter-rule" />
          <h3>Rebalancing as Discipline, Not Trading</h3>
          <p>Rebalancing should not be confused with frequent trading. Its purpose is not to react to short-term market movements but to maintain the structure of a long-term investment strategy. In many ways, rebalancing enforces the discipline of selling high and buying relatively lower &mdash; without relying on market timing. Most investors only need to rebalance their portfolios occasionally, ensuring that the portfolio continues to reflect their financial goals, risk tolerance and investment horizon.</p>
          <blockquote className="pull-quote">Rebalancing is one of the most disciplined acts in investing. It forces you to take profits from what has grown and reinvest into what has lagged &mdash; exactly the opposite of what emotions tend to push you toward.</blockquote>
        </>
      ),
    },
    ...
    // ==============================
    {
      ...
      content: (
        <>
          ...
          <blockquote className="pull-quote">Wealth is built not by predicting markets but by building a system &mdash; and then having the discipline to trust that system through every market cycle.</blockquote>
        </>
      ),
    },
  ];
