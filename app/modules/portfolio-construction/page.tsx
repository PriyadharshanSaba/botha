      ...
      <main className="container module-detail-container">
        ...
        <div className="complete-inner">
          ...
          <div className="complete-title">
            Module 8<br /><em>Complete.</em>
          </div>
          <p className="complete-sub">
            You&apos;ve finished Portfolio Construction &amp; Personal Wealth Framework &mdash; all 12 chapters. You now have a complete framework for structuring your financial life: net worth thinking, risk capacity, emergency funds, asset allocation, diversification, rebalancing, SIPs and the behavioral discipline to hold it all together.
          </p>
