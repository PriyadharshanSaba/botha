    ...
    return (
      <>
        ...
        <ul className="pl-6 list-disc space-y-1">
          ...
          <li>
            <strong>ಸೆನ್ಸೆಕ್ಸ್:</strong> BSE ನಲ್ಲಿ ಪಟ್ಟಿಯಾದ ೩೦ ಪ್ರಮುಖ ಕಂಪನಿಗಳು. ಒಟ್ಟಾಗಿ, ಈ ಎರಡೂ ಭಾರತದ ಆರ್ಥಿಕ ಹವಾಮಾನವನ್ನು ಅಳೆಯುವ ಅವಳಿ ತಾಪಮಾಪಕಗಳಂತಿವೆ.
          </li>
        </ul>
    ...
    return (
      <>
        ...
        <ul className="pl-6 list-disc space-y-1">
          ...
          <li>
            <strong>ವಿಭಜನೆ:</strong> ಕಂಪನಿಯು ತನ್ನ ಒಂದು ವ್ಯವಹಾರ ವಿಭಾಗವನ್ನು ಪ್ರತ್ಯೇಕ ಸಂಸ್ಥೆಯಾಗಿ ಬೇರ್ಪಡಿಸುತ್ತದೆ (ರಿಲಯನ್ಸ್ Jio ಫೈನಾನ್ಷಿಯಲ್ ಅನ್ನು ಬೇರ್ಪಡಿಸಿದಂತೆ). ಈ ಕ್ರಮಗಳು ನಿಮ್ಮ ಪೋರ್ಟ್‌ಫೋಲಿಯೋವನ್ನು ಪುನರ್ರಚಿಸಬಲ್ಲವು — ವಿಲೀನ ಅಥವಾ ಬೇರ್ಪಟ್ಟ ಕಂಪನಿಯಲ್ಲಿ ನಿಮಗೆ ಹೊಸ ಷೇರುಗಳು ಸಿಗಬಹುದು.
          </li>
        </ul>
      </>
    );
