...
export default function StockMarketPage() {
  ...
  const chapters = [
    ...
    {
      title: "Chapter 2: Why Does the Stock Market Exist?",
      content: (
        <>
          <p>
    ...
    {
      title: "Chapter 3: The Key Players — Who Makes It All Work",
      content: (
        <>
          <p>
    ...
    {
      title: "Chapter 4: IPOs & FPOs — How Companies Raise Money",
      content: (
        <>
          <p>
    ...
    {
      title: "Chapter 5: Indices — The Market’s Pulse",
      content: (
        <>
          <p>
    ...
    {
      title: "Chapter 6: Understanding the Basics — Key Jargon Simplified",
      content: (
        <>
          <ul>
    ...
    {
      title: "Chapter 7: Corporate Actions — When Companies Reshape Value",
      content: (
        <>
          <ul>
            ...
            <li><strong>Rights Issue:</strong> Offering more shares to existing investors at a discount.</li>
            <li><strong>Buyback:</strong> Company repurchases its own shares to boost value.</li>
            <li><strong>Merger / Demerger:</strong> Companies combine or separate, reshaping ownership and value.</li>
          </ul>
        </>
      ),
    },
    ...
    {
      title: "Chapter 8: Wrapping Up — You Now Speak the Market’s Language",
      content: (
        <>
          <p>
