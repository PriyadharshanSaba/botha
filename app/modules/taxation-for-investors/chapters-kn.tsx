...
export const chaptersKn: { title: string; content: React.ReactNode }[] = [
  ...
  // ==============================
  {
    title: "ಅಧ್ಯಾಯ 1: ಭಾರತದ ಆದಾಯ ತೆರಿಗೆ ವ್ಯವಸ್ಥೆಯ ಪರಿಚಯ",
    content: (
      <>
        <p>
  ...
  // ==============================
  {
    title: "ಅಧ್ಯಾಯ 2: ಬಂಡವಾಳ ಲಾಭ - ಹೂಡಿಕೆ ತೆರಿಗೆಯ ಅಡಿಪಾಯ",
    content: (
      <>
        <p>
  ...
  // ==============================
  {
    title: "ಅಧ್ಯಾಯ 3: ಷೇರು ಹೂಡಿಕೆಗಳ ತೆರಿಗೆ",
    content: (
      <>
        <p>
  ...
  // ==============================
  {
    title: "ಅಧ್ಯಾಯ 4: ಮ್ಯೂಚುಯಲ್ ಫಂಡ್‌ಗಳ ತೆರಿಗೆ",
    content: (
      <>
        <p>
  ...
  // ==============================
  {
    title: "ಅಧ್ಯಾಯ 5: ಗ್ರೋತ್ vs IDCW - ತೆರಿಗೆ ಪರಿಣಾಮ ಮತ್ತು ಕಂಪೌಂಡಿಂಗ್",
    content: (
      <>
        <p>
  ...
  // ==============================
  {
    title: "ಅಧ್ಯಾಯ 6: ಡಿವಿಡೆಂಡ್ ತೆರಿಗೆ",
    content: (
      <>
        <p>
  ...
  // ==============================
  {
    title: "ಅಧ್ಯಾಯ 7: ಬಡ್ಡಿ ಆದಾಯ ಮತ್ತು ಸ್ಥಿರ ಆದಾಯ ತೆರಿಗೆ",
    content: (
      <>
        <p>
  ...
  // ==============================
  {
    title: "ಅಧ್ಯಾಯ 8: ತೆರಿಗೆ ನಷ್ಟ ಕಟಾವು",
    content: (
      <>
        <p>
