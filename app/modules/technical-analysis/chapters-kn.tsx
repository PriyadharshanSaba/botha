...
export const chaptersKn: { title: string; content: React.ReactNode }[] = [
  ...
  /* ------------------------------------------------------------------ */
  {
    title: "ಅಧ್ಯಾಯ 1೦: ಬೊಲ್ಲಿಂಜರ್ ಬ್ಯಾಂಡ್‌ಗಳು — ಚಂಚಲತೆ ಅರ್ಥಮಾಡಿಕೊಳ್ಳುವುದು",
    content: (
      <>
  ...
  /* ------------------------------------------------------------------ */
  {
    title: "ಅಧ್ಯಾಯ 1೧: MACD — ಚಲನ ಶಕ್ತಿ ವೇಗ ಮತ್ತು ಬದಲಾವಣೆ ಅಳೆಯುವುದು",
    content: (
      <>
  ...
  /* ------------------------------------------------------------------ */
  {
    title: "ಅಧ್ಯಾಯ 1೨: ಬ್ರೇಕ್‌ಔಟ್ ಮತ್ತು ಹಿಂಸೆ ಕಾರ್ಯತಂತ್ರಗಳು",
    content: (
      <>
  ...
  /* ------------------------------------------------------------------ */
  {
    title: "ಅಧ್ಯಾಯ 1೩: ಚಾರ್ಟ್ ಮಾದರಿಗಳು — ಪ್ರದರ್ಶಿಸಲ್ಪಡುವ ಮಾನಸಿಕಸ್ಥಿತಿ",
    content: (
      <>
  ...
  /* ------------------------------------------------------------------ */
  {
    title: "ಅಧ್ಯಾಯ 1೪: ಬಹು-ಸಮಯ ಚೌಕಟ್ಟು ವಿಶ್ಲೇಷಣೆ",
    content: (
      <>
  ...
  /* ------------------------------------------------------------------ */
  {
    title: "ಅಧ್ಯಾಯ 1೫: ಅಪಾಯ ನಿರ್ವಹಣೆ — ಸಂಪತ್ತು ಸಂಚಯಿಸುತ್ತ ಬಂಡವಾಳ ರಕ್ಷಣೆ",
    content: (
      <>
  ...
  /* ------------------------------------------------------------------ */
  {
    title: "ಅಧ್ಯಾಯ 1೬: ಪ್ರಕರಣ ಅಧ್ಯಯನಗಳು — ಭಾರತೀಯ ಮಾರುಕಟ್ಟೆ ಉದಾಹರಣೆಗಳು",
    content: (
      <>
  ...
  /* ------------------------------------------------------------------ */
  {
    title: "ಅಧ್ಯಾಯ 1೭: ಸಾಮಾನ್ಯ ತಾಂತ್ರಿಕ ತಪ್ಪುಗಳು",
    content: (
      <>
  ...
  /* ------------------------------------------------------------------ */
  {
    title: "ಅಧ್ಯಾಯ 1೮: ಮೂಲಭೂತ ಮತ್ತು ತಾಂತ್ರಿಕ ಅಂಶಗಳ ಸಂಯೋಜನೆ",
    content: (
      <>
  ...
  /* ------------------------------------------------------------------ */
  {
    title: "ಅಧ್ಯಾಯ 1೯: ಹೂಡಿಕೆದಾರನ ಮನೋಭಾವ — ನಿಜವಾಗಿ ಸಂಪತ್ತು ನಿರ್ಮಿಸುವ ಅಂಶ",
    content: (
      <>
