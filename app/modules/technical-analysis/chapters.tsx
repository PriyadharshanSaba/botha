      ...
      content: (
        <>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "auto auto", gap: "8px 12px", margin: "28px 0", alignItems: "end", justifyContent: "center", justifyItems: "center" }}>
              ...
              <p className="img-caption" style={{ margin: 0, textAlign: "center" }}>Buyers in Control</p>
              <p className="img-caption" style={{ margin: 0, textAlign: "center" }}>Sellers in Control</p>
            </div>
            ...
            <p className="img-caption">An extreme example but again from the Reliance Chart</p>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "auto auto", gap: "8px 12px", margin: "28px 0", alignItems: "end", justifyContent: "center", justifyItems: "center" }}>
              ...
              <p className="img-caption" style={{ margin: 0, textAlign: "center" }}>Strong Bearish Candle</p>
              <p className="img-caption" style={{ margin: 0, textAlign: "center" }}>Weak Bearish Candle</p>
            </div>
...
export const chapters = chaptersEn.map((ch, i) => ({
