    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p>In strong uptrends, RSI can remain above 60–70 for extended periods because sustained buying pressure keeps momentum elevated. In strong downtrends, RSI can remain below 40–30 due to persistent selling pressure. RSI is not a buy/sell switch — it is a momentum gauge that helps you understand whether price is moving with strength, losing momentum, or reaching extremes.</p>
          <hr className="chapter-rule" />
          <h3>What &quot;Overbought&quot; and &quot;Oversold&quot; Actually Mean</h3>
          <p><strong>Overbought does NOT mean &quot;sell immediately.&quot; Oversold does NOT mean &quot;buy immediately.&quot;</strong> These terms describe momentum conditions, not guaranteed reversals. In powerful uptrends, RSI can stay above 60–70 for extended periods — selling purely because RSI is overbought can mean exiting strong trends too early. In strong downtrends, RSI near 30 often reflects persistent weakness — buying simply because RSI is oversold can mean catching falling knives.</p>
          <hr className="chapter-rule" />
          <h3>RSI Ranges in Uptrends vs Downtrends</h3>
          <p>In healthy uptrends, RSI often stays between 40–80. Pullbacks frequently find support near 40–50 and RSI rarely drops below 30. If RSI repeatedly holds above 40 during pullbacks, it confirms underlying strength. In sustained downtrends, RSI often stays between 20–60. Rallies frequently stall near 50–60 and RSI rarely crosses above 70. Understanding these shifting ranges is far more important than mechanically reacting to 70 and 30. In uptrends, RSI lives in a higher range. In downtrends, it lives in a lower range.</p>
          <hr className="chapter-rule" />
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p>Even the most promising companies can face unexpected setbacks — industries change, management decisions go wrong, regulation shifts, market cycles turn. Because of this uncertainty, avoid concentrating excessive capital in a single position. A structured allocation framework helps: core positions at 10–20% allocation, high-conviction opportunities at 5–10%, and smaller exploratory positions at 2–5%. Diversification is not about owning dozens of random stocks — it is about ensuring that no single mistake can cause irreversible damage.</p>
          <hr className="chapter-rule" />
